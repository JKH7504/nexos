...
import nexos.service.lo.LOB01020Q0Service;
 ...
 */
@Controller
@RequestMapping("/LOB01020Q0")
public class LOB01020Q0Controller extends ControllerSupport {

    @Autowired
    private LOB01020Q0Service service;
