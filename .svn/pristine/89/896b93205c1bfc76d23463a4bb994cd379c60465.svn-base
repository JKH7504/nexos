...
import nexos.dao.ro.ROC05050E0DAO;
...
/**
 * Class: ROC05050E0Service<br>
 * Description: 반출시리얼처리(ROC05050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class ROC05050E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(ROC05050E0Service.class);

    final String          SP_ID_GET_RO_OUTBOUND_STATE = "WF.GET_RO_OUTBOUND_STATE";

    @Autowired
    private ROC05050E0DAO dao;
