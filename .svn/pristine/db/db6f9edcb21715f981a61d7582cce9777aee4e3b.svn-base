...
/**
 * Class: LFC05040E0DAOImpl<br>
 * Description: LFC05040E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05040E0DAO")
public class LFC05040E0DAOImpl extends DaoSupport implements LFC05040E0DAO {

    final String PROGRAM_ID        = "LFC05040E0";

    final String TABLE_NM_LF220NM  = "LF220NM";
    final String UPDATE_ID_LF220NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF220NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF220NM, rowData);
            }
        }
    }
}
