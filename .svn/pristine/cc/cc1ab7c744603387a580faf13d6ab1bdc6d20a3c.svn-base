...
/**
 * Class: LCC02010E0DAOImpl<br>
 * Description: LCC02010E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LCC02010E0DAO")
public class LCC02010E0DAOImpl extends DaoSupport implements LCC02010E0DAO {

    final String PROGRAM_ID                     = "LCC02010E0";
    ...
    final String SP_ID_LC_FW_STATE_CHANGE_ENTRY = "LC_FW_STATE_CHANGE_ENTRY";
     ...
     */
    @Override
    public Map<String, Object> callLCFWStateChangeEntry(Map<String, Object> params) throws Exception {
        ...
        // 프로시저 호출
        return callProcedure(SP_ID_LC_FW_STATE_CHANGE_ENTRY, params);
    }
}
