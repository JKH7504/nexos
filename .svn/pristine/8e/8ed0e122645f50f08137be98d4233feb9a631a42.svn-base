...
import nexos.dao.li.LIC05090E0DAO;
import nexos.framework.Consts;
import nexos.framework.Util;
import nexos.framework.support.ServiceSupport;

/**
 * Class: LIC05090E0Service<br>
 * Description: 입고작업비등록(LIC05090E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LIC05090E0Service extends ServiceSupport {

    final String          SP_ID_GET_PROTECT = "WF.GET_PROTECT";

    @Autowired
    private LIC05090E0DAO dao;
