...
/**
 * Class: LFC05010E0DAOImpl<br>
 * Description: LFC05010E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05010E0DAO")
public class LFC05010E0DAOImpl extends DaoSupport implements LFC05010E0DAO {

    final String PROGRAM_ID        = "LFC05010E0";

    final String TABLE_NM_LF110NM  = "LF110NM";
    final String UPDATE_ID_LF110NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF110NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF110NM, rowData);
            }
        }
    }
}
