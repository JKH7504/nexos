...
import nexos.service.cm.CMC04060E0Service;
 ...
 */
@Controller
@RequestMapping("/CMC04060E0")
public class CMC04060E0Controller extends ControllerSupport {

    @Autowired
    private CMC04060E0Service service;
    ...
    public ResponseEntity<String> callVendorItemAddItem(HttpServletRequest request, @RequestBody Map<String, Object> params) {
    ...
    public ResponseEntity<String> callVendorItemAddVendor(HttpServletRequest request, @RequestBody Map<String, Object> params) {
