...
import nexos.service.pda.PDA_LOC02350E0Service;

/**
 * Class: PDA_LOC02350E0Controller<br>
 * Description: PDA 수동DAS작업 컨트롤러<br>
 ...
 */
@Controller
@RequestMapping("/PDA_LOC02350E0")
public class PDA_LOC02350E0Controller extends ControllerSupport {

    @Autowired
    private PDA_LOC02350E0Service service;
     ...
     * @return
     */
    @RequestMapping(value = "/callLOProcDistribute.do", method = RequestMethod.POST)
    public ResponseEntity<String> callLOProcDistribute(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callLOProcDistribute(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
