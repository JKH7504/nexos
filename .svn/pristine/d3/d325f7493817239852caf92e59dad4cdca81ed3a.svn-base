...
import nexos.service.cm.CMC01020E0Service;
 ...
 */
@Controller
@RequestMapping("/CMC01020E0")
public class CMC01020E0Controller extends ControllerSupport {

    @Autowired
    private CMC01020E0Service service;
