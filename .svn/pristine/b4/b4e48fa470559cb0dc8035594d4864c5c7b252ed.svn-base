...
function _OnLoaded() {
    ...
    // 데이터 조회
    $NC.serviceCall("/LOF02010E0/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function onClose() {
    ...
    if (G_GRDMASTER.data.getLength() == 0) {
        alert($NC.getDisplayMsg("JS.LOF02012P0.XXX", "저장할 데이터가 없습니다."));
        return;
    }
