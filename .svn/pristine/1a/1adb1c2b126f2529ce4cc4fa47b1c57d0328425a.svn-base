...
import nexos.dao.lc.LCC03010E0DAO;
...
/**
 * Class: LCC03010E0Service<br>
 * Description: 재고이동(LCC03010E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC03010E0Service extends ServiceSupport {
    ...
    final String          SP_ID_LC_FW_REPLENISH_ENTRY = "LC_FW_REPLENISH_ENTRY";
    final String          SP_ID_LC_FW_REPLENISH_SPOT  = "LC_FW_REPLENISH_SPOT";

    @Autowired
    private LCC03010E0DAO dao;
     ...
     */
    public Map<String, Object> callLcFWFillupEmergencyEntry(Map<String, Object> params) throws Exception {

        Map<String, Object> resultMap;

        TransactionStatus ts = beginTrans();
        try {
            resultMap = callProcedure(SP_ID_LC_FW_REPLENISH_ENTRY, params);
    ...
    /**
     * 수시보충 SP 실행 후 처리 결과를 Map 형태로 Return
     */
    public Map<String, Object> callLcFWFillupSpotEntry(Map<String, Object> params) throws Exception {
        ...
        try {
            ...
            getDefaultDao().insertCheckedValue(checkedParams);

            resultMap = callProcedure(SP_ID_LC_FW_REPLENISH_SPOT, params);
