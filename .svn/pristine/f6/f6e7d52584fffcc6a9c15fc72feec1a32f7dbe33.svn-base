...
import nexos.dao.scan.SCAN_LOB03010E0DAO;
...
/**
 * Class: SCAN_LOB03010E0Service<br>
 ...
 */
@Service
public class SCAN_LOB03010E0Service extends ServiceSupport {

    @Autowired
    private SCAN_LOB03010E0DAO dao;
        ...
        if (Consts.YES.equals(completeYn) && Consts.HDC_DIV_HANJIN_B2C.equals(hdcDiv) && !"1".equals(boxNo)) {
            ...
            if (Util.isNull(wbNo)) {
                throw new RuntimeException( //
                    NexosMessage.getDisplayMsg("JAVA.SCAN_LOB03010E0SERVICE.XXX", "[한진택배]송장번호를 채번하지 못해 저장할 수 없습니다.") //
