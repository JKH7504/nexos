...
function _OnCustomizeDefaultOptions(siteOptions) {
    ...
    /**
     * -----------------------------------------------------------------------------------------------------------------------------------------------
     * 사운드 관련 세팅, since 7.5.0
     * -----------------------------------------------------------------------------------------------------------------------------------------------
     */
    /**
     * 기본 사운드, $NC.playAlertSound(), $NC.playWarningSound(), $NC.playErrorSound()로 호출<br>
     * Alert, Warning, Error 순서로 사운드 확장자를 제외한 파일명을 소문자(자동변환)로 입력<br>
     * 사운드 파일 위치: nexos/framework/css/sound<br>
     * 사운드 파일: 지정 명칭의 (wav, mp3) 파일 추가<br>
     * 기본 사운드 파일: alert, warning, error1, error2 파일 존재<br>
     * alert: nexos/framework/css/sound/alert.wav, nexos/framework/css/sound/alert.mp3<br>
     * warning: nexos/framework/css/sound/warning.wav, nexos/framework/css/sound/warning.mp3<br>
     * error1: nexos/framework/css/sound/error1.wav, nexos/framework/css/sound/error1.mp3<br>
     * error2: nexos/framework/css/sound/error2.wav, nexos/framework/css/sound/error2.mp3
     */
    // siteOptions.G_SOUND.DEFAULT = [
    // "alert",
    // "warning",
    // "error1"
    // ];
    /**
     * 추가 사운드, $NC.playSound("error2")로 호출, 현재 추가 사운드는 지정되어 있지 않음
     */
    // siteOptions.G_SOUND.ADDITIONAL = [
    // "error2"
    // ];
    /**
     * -----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    var redefineConstProps = {
        ...
        // C_HDC_DIV_HANJIN_B2B: "A1",// 택배사구분 - 한진택배B2B, since 7.5.0
        // C_HDC_DIV_HANJIN_B2C: "A2",// 택배사구분 - 한진택배B2C, since 7.5.0
        // C_HDC_DIV_EPOST_B2B: "B1",// 택배사구분 - 우체국택배B2B, since 7.5.0
        // C_HDC_DIV_EPOST_B2C: "B2",// 택배사구분 - 우체국택배B2C, since 7.5.0
        // C_HDC_DIV_CJ_B2B: "C1",// 택배사구분 - CJ대한통운B2B, since 7.5.0
        // C_HDC_DIV_CJ_B2C: "C2",// 택배사구분 - CJ대한통운B2C, since 7.5.0
        // C_HDC_DIV_LOTTE_B2B: "D1",// 택배사구분 - 롯데택배B2B, since 7.5.0
        // C_HDC_DIV_LOTTE_B2C: "D2", // 택배사구분 - 롯데택배B2C, since 7.5.0
        // C_REASON_ETC_DIV: "99", // 사유구분값 중 기타에 해당하는 값 99 - 기타
        C_TIMEOUT_FOCUS: 200, // 스캔 Editor 포커스시 Delay Time(ms)
