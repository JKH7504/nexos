...
import nexos.dao.li.LIC05050E0DAO;
...
/**
 * Class: LIC05050E0Service<br>
 * Description: 입고시리얼처리(LIC05050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LIC05050E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(LIC05050E0Service.class);

    final String          SP_ID_GET_LI_INBOUND_STATE = "WF.GET_LI_INBOUND_STATE";

    @Autowired
    private LIC05050E0DAO dao;
