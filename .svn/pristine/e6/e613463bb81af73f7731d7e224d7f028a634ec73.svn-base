...
function _OnConditionChange(e, view, val) {
    ...
    switch (id) {
        ...
        case "BRAND_CD":
            ...
            return;
        case "INOUT_DATE":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LSC03010Q1.001", "기준일자를 정확히 입력하십시오."));
            break;
        case "INOUT_DATE1":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LSC03010Q1.002", "기준 시작일자를 정확히 입력하십시오."));
            break;
        case "INOUT_DATE2":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LSC03010Q1.003", "기준 종료일자를 정확히 입력하십시오."));
            break;
    }
...
function _Inquiry() {
    ...
    if ($NC.isNull(CENTER_CD)) {
        alert($NC.getDisplayMsg("JS.LSC03010Q1.004", "물류센터를 선택하십시오."));
        $NC.setFocus("#cboQCenter_Cd");
        return;
    }
    var BU_CD = $NC.getValue("#edtQBu_Cd");
    if ($NC.isNull(BU_CD)) {
        alert($NC.getDisplayMsg("JS.LSC03010Q1.005", "사업부를 입력하십시오."));
    ...
    if (tabActiveIndex < 2) {
        ...
        if ($NC.isNull(BASE_DATE)) {
            alert($NC.getDisplayMsg("JS.LSC03010Q1.006", "기준일자를 입력하십시오."));
        ...
        if ($NC.isNull(INOUT_DATE1)) {
            alert($NC.getDisplayMsg("JS.LSC03010Q1.007", "기준 시작일자를 입력하십시오."));
        ...
        if ($NC.isNull(INOUT_DATE2)) {
            alert($NC.getDisplayMsg("JS.LSC03010Q1.008", "기준 종료일자를 입력하십시오."));
            $NC.setFocus("#dtpQInout_Date2");
            return;
        }

        if (INOUT_DATE1 > INOUT_DATE2) {
            alert($NC.getDisplayMsg("JS.LSC03010Q1.009", "기준일자 검색 범위 오류입니다."));
            $NC.setFocus("#dtpQInout_Date1");
            return;
        }
...
function grdT1MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT1Master", {
        ...
        queryId: "LSC03010Q1.RS_T1_MASTER",
        sortCol: "ITEM_CD",
        gridOptions: options
    });
...
function grdT2MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT2Master", {
        ...
        queryId: "LSC03010Q1.RS_T2_MASTER",
        sortCol: "ITEM_CD",
        gridOptions: options
    });
...
function grdT3MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT3Master", {
        ...
        queryId: "LSC03010Q1.RS_T3_MASTER",
        sortCol: "ITEM_CD",
        gridOptions: options
    });
...
function grdT4MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT4Master", {
        ...
        queryId: "LSC03010Q1.RS_T4_MASTER",
        sortCol: "ITEM_CD",
        gridOptions: options
    });
...
function grdT4DetailInitialize() {
    ...
    $NC.setInitGridObject("#grdT4Detail", {
        ...
        queryId: "LSC03010Q1.RS_T4_DETAIL",
...
function grdT5MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT5Master", {
        ...
        queryId: "LSC03010Q1.RS_T5_MASTER",
        sortCol: "ITEM_CD",
        gridOptions: options
    });
...
function grdT6MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT6Master", {
        ...
        queryId: "LSC03010Q1.RS_T6_MASTER",
        sortCol: "LOCATION_CD",
        gridOptions: options
    });
