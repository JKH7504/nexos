...
import nexos.dao.lo.LOM02010E0DAO;
...
/**
 * Class: LOM02010E0Service<br>
 * Description: 출고작업(LOM02010E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LOM02010E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(LOM02010E0Service.class);
