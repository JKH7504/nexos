...
/**
 * Class: LFC05110E0DAOImpl<br>
 * Description: LFC05110E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05110E0DAO")
public class LFC05110E0DAOImpl extends DaoSupport implements LFC05110E0DAO {

    final String PROGRAM_ID        = "LFC05110E0";

    final String TABLE_NM_LF230NM  = "LF230NM";
    final String UPDATE_ID_LF230NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF230NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            callParams.put("P_PROTECT_DATE", rowData.get("P_OUTBOUND_DATE"));
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF230NM, rowData);
            }
        }
    }
}
