...
import nexos.service.cm.CMC05010E0Service;
 ...
 */
@Controller
@RequestMapping("/CMC05010E0")
public class CMC05010E0Controller extends ControllerSupport {

    @Autowired
    private CMC05010E0Service service;
