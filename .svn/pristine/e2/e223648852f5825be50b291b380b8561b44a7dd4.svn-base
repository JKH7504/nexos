...
function _OnLoaded() {
    ...
    G_GRDMASTER.queryParams = {
        ...
        P_STOCK_ID: $NC.G_VAR.G_PARAMETER.P_STOCK_ID
    };
    // 데이터 조회
    $NC.serviceCall("/LSC01040Q0/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
