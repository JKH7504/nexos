...
/**
 * Class: [송신]CJ대한통운 반품요청 결과 관리<br>
 * Description: [송신]CJ대한통운 반품요청 결과 관리 Controller
 ...
 */
@Controller
@RequestMapping("/EDR09020E0")
public class EDR09020E0Controller extends ControllerSupport {
