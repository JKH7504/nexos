...
function _Initialize() {
    ...
    $NC.serviceCall("/WC/getMultiDataSet.do", {
        P_SERVICE_PARAMS: [
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_KEEP_DIV_2",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_KEEP_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
                    P_COMMON_GRP: "KEEP_DIV",
                    P_COMMON_CD: $ND.C_ALL,
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_PLT_SPLIT_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_VALID_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_TERM_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_LABELLING_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
                    P_COMMON_GRP: "LABELLING_DIV",
                    P_COMMON_CD: $ND.C_ALL,
                    P_VIEW_DIV: "1" // 1:등록팝업, 2:조회팝업
                }
            },
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_IN_UNIT_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_OUT_UNIT_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_AGING_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
                    P_COMMON_GRP: "AGING_DIV",
                    P_COMMON_CD: $ND.C_ALL,
                    P_VIEW_DIV: "1" // 1:등록팝업, 2:조회팝업
                }
            },
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_PROCURE_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
                    P_COMMON_GRP: "PROCURE_DIV",
                    P_COMMON_CD: $ND.C_ALL,
                    P_VIEW_DIV: "1" // 1:등록팝업, 2:조회팝업
                }
            },
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_CLASS_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_SERIAL_IN_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
            ...
            {
                P_RESULT_ID: "O_WC_POP_CMCODE_SERIAL_OUT_DIV_1",
                P_QUERY_ID: "WC.POP_CMCODE",
                P_QUERY_PARAMS: {
        ...
        $NC.setInitComboData({
            ...
            fullNameField: "COMMON_CD_F",
            addAll: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_KEEP_DIV_2),
            onComplete: function() {
        ...
        $NC.setInitComboData({
            ...
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_KEEP_DIV_1),
            onComplete: function() {
        ...
        $NC.setInitComboData({
            ...
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_PLT_SPLIT_DIV_1),
            onComplete: function() {
        ...
        $NC.setInitComboData({
            ...
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_VALID_DIV_1),
            addEmpty: true,
            onComplete: function() {
        ...
        $NC.setInitComboData({
            ...
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_TERM_DIV_1),
            addEmpty: true,
            onComplete: function() {
        ...
        // 라벨링구분 콤보
        $NC.setInitComboData({
            selector: "#cboLabelling_Div",
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_LABELLING_DIV_1),
            onComplete: function() {
                $NC.setValue("#cboLabelling_Div");
            }
        });
        // 입고단위 콤보
        $NC.setInitComboData({
            ...
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_IN_UNIT_DIV_1),
            onComplete: function() {
        ...
        $NC.setInitComboData({
            ...
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_OUT_UNIT_DIV_1),
            onComplete: function() {
        ...
        // 숙성단위 콤보
        $NC.setInitComboData({
            selector: "#cboAging_Div",
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_AGING_DIV_1),
            onComplete: function() {
                $NC.setValue("#cboAging_Div");
            }
        });
        // 조달단위 콤보
        $NC.setInitComboData({
            selector: "#cboProcure_Div",
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_PROCURE_DIV_1),
            onComplete: function() {
                $NC.setValue("#cboProcure_Div");
            }
        });
        // 분류단위 콤보
        $NC.setInitComboData({
            selector: "#cboClass_Div",
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            addEmpty: true,
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_CLASS_DIV_1),
            onComplete: function() {
                $NC.setValue("#cboClass_Div");
            }
        });
        // 입고일련번호관리구분 콤보
        $NC.setInitComboData({
            ...
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_SERIAL_IN_DIV_1),
            onComplete: function() {
        ...
        $NC.setInitComboData({
            ...
            codeField: "COMMON_CD",
            fullNameField: "COMMON_CD_F",
            data: $NC.toArray(multipleData.O_WC_POP_CMCODE_SERIAL_OUT_DIV_1),
            onComplete: function() {
...
function _OnConditionChange(e, view, val) {
    ...
    switch (id) {
        ...
        case "BRAND_CD":
            ...
            return;
        case "DEPART_CD":
            setQLineCombo($NC.getValue("#cboQLine_Cd"));
            break;
        case "LINE_CD":
            setQClassCombo($NC.getValue("#cboQLine_Cd"), $NC.getValue("#cboQClass_Cd"));
            break;
    }
...
function _Inquiry() {
    ...
    if ($NC.isNull(CUST_CD)) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.001", "고객사를 입력하십시오."));
    ...
    var ITEM_DIV = $NC.getValue("#cboQItem_Div", true);
    var KEEP_DIV = $NC.getValue("#cboQKeep_Div", true);
...
function _New() {
    ...
    if (G_GRDMASTER.focused) {
        ...
        newRowData = {
            ...
            SET_ITEM_YN: $ND.C_NO,
            SEASON_YN: $ND.C_NO,
            WEIGHT_ITEM_YN: $ND.C_NO,
            DISCARD_PURCHASE_YN: $ND.C_NO,
            DISCARD_SALE_YN: $ND.C_NO,
            SERIAL_IN_DIV: "1",
            SERIAL_OUT_DIV: "1",
            LOT_NO_REQ_YN: $ND.C_NO,
            VALID_DATE_REQ_YN: $ND.C_NO,
            BATCH_NO_REQ_YN: $ND.C_NO,
            LABELLING_DIV: null,
            DEPT_CD: null,
            AGING_DIV: null,
            PROCURE_DIV: null,
    ...
    // 바코드
        ...
        if (G_GRDMASTER.data.getLength() == 0 || $NC.isNull(G_GRDMASTER.lastRow)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.002", "상품 내역이 없습니다.\n\n상품을 먼저 등록하십시오."));
            return;
        }
        ...
        if (refRowData.CRUD == $ND.C_DV_CRUD_N || refRowData.CRUD == $ND.C_DV_CRUD_C) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.003", "신규 상품 입니다.\n\n저장 후 상품바코드를 등록하십시오."));
            return;
        }
        ...
        newRowData = {
            ...
            ITEM_PACK: "",
            DEAL_DIV: "1",
            DEAL_DIV_F: $NC.getGridComboName(G_GRDDETAIL, {
                columnId: "DEAL_DIV_F",
                searchVal: "1",
...
function _Save() {
    ...
    if (G_GRDMASTER.data.getLength() == 0) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.004", "저장할 데이터가 없습니다."));
        return;
    }
    ...
    for (rIndex = 0, rCount = G_GRDMASTER.data.getLength(); rIndex < rCount; rIndex++) {
        ...
        dsMaster.push({
            ...
            P_IDENTIFY_CD: rowData.IDENTIFY_CD,
            ...
            P_SEASON_YN: rowData.SEASON_YN,
            P_WEIGHT_ITEM_YN: rowData.WEIGHT_ITEM_YN,
            P_DISCARD_PURCHASE_YN: rowData.DISCARD_PURCHASE_YN,
            P_DISCARD_SALE_YN: rowData.DISCARD_SALE_YN,
            P_SERIAL_IN_DIV: $NC.G_VAR.policyVal.CM490 == $ND.C_YES ? rowData.SERIAL_IN_DIV : "1",
            P_SERIAL_OUT_DIV: $NC.G_VAR.policyVal.CM490 == $ND.C_YES ? rowData.SERIAL_OUT_DIV : "1",
            P_LOT_NO_REQ_YN: rowData.LOT_NO_REQ_YN,
            P_VALID_DATE_REQ_YN: rowData.VALID_DATE_REQ_YN,
            P_BATCH_NO_REQ_YN: rowData.BATCH_NO_REQ_YN,
            P_LABELLING_DIV: rowData.LABELLING_DIV,
            P_DEPT_CD: rowData.DEPT_CD,
            P_AGING_DIV: rowData.AGING_DIV,
            P_PROCURE_DIV: rowData.PROCURE_DIV,
            P_CLASS_DIV: rowData.CLASS_DIV,
            P_DEAL_DIV: rowData.DEAL_DIV,
            P_OPEN_DATE: rowData.OPEN_DATE,
            P_CLOSE_DATE: rowData.CLOSE_DATE,
            P_REMARK1: rowData.REMARK1,
            P_CMITEMBARCD_REG_YN: $NC.G_VAR.policyVal.CM310 == $ND.C_POLICY_VAL_2 ? $ND.C_YES : $ND.C_NO,
            P_RESTRICT_OUT_DAY: rowData.RESTRICT_OUT_DAY,
            P_IMMINENT_STOCK_DAY: rowData.IMMINENT_STOCK_DAY,
            P_CRUD: rowData.CRUD
        });
    }
    ...
    if (dsMaster.length == 0 && dsDetail.length == 0) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.005", "데이터 수정 후 저장하십시오."));
        return;
    }
...
function _Delete() {
    ...
    if (G_GRDMASTER.focused) {
        if (G_GRDMASTER.data.getLength() == 0 || $NC.isNull(G_GRDMASTER.lastRow)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.006", "삭제할 데이터가 없습니다."));
            return;
        }

        if (!confirm($NC.getDisplayMsg("JS.CMC04020E0.007", "상품 정보를 삭제 하시겠습니까?"))) {
            return;
        }
        ...
        if (!confirm($NC.getDisplayMsg("JS.CMC04020E0.008", "상품바코드를 삭제 하시겠습니까?"))) {
            return;
        }
...
function setInputValue(grdSelector, rowData) {
    ...
    if (grdSelector == "#grdMaster") {
        ...
        $NC.setValue("#edtIdentify_Cd", rowData.IDENTIFY_CD);
        ...
        $NC.setValue("#chkSeason_Yn", rowData.SEASON_YN);
        $NC.setValue("#chkWeight_Item_Yn", rowData.WEIGHT_ITEM_YN);
        $NC.setValue("#chkDiscard_Purchase_Yn", rowData.DISCARD_PURCHASE_YN);
        $NC.setValue("#chkDiscard_Sale_Yn", rowData.DISCARD_SALE_YN);
        $NC.setValue("#cboSerial_In_Div", rowData.SERIAL_IN_DIV);
        $NC.setValue("#cboSerial_Out_Div", rowData.SERIAL_OUT_DIV);
        $NC.setValue("#chkLot_No_Req_Yn", rowData.LOT_NO_REQ_YN);
        $NC.setValue("#chkValid_Date_Req_Yn", rowData.VALID_DATE_REQ_YN);
        $NC.setValue("#chkBatch_No_Req_Yn", rowData.BATCH_NO_REQ_YN);
        $NC.setValue("#cboLabelling_Div", rowData.LABELLING_DIV);
        $NC.setValue("#edtDept_Cd", rowData.DEPT_CD);
        $NC.setValue("#edtDept_Nm", rowData.DEPT_NM);
        $NC.setValue("#cboAging_Div", rowData.AGING_DIV);
        $NC.setValue("#cboProcure_Div", rowData.PROCURE_DIV);
        $NC.setValue("#cboClass_Div", rowData.CLASS_DIV);
        ...
        $NC.setValue("#edtRestrict_Out_Day", rowData.RESTRICT_OUT_DAY);
        $NC.setValue("#edtImminent_Stock_Day", rowData.IMMINENT_STOCK_DAY);
...
function grdMasterOnBeforePost(row) {
    ...
    if (rowData.CRUD != $ND.C_DV_CRUD_R) {
        if ($NC.isNull(rowData.BRAND_CD)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.009", "브랜드코드를 입력하십시오."));
        ...
        if ($NC.isNull(rowData.ITEM_CD)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.010", "상품코드를 입력하십시오."));
            $NC.setTabActiveIndex("#divRightView", 0);
            $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.isNull(rowData.ITEM_NM)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.011", "상품명을 입력하십시오."));
            $NC.setTabActiveIndex("#divRightView", 0);
            $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.G_VAR.policyVal.CM310 == "2") {
            ...
            if (ITEM_BARCD == BOX_BAR_CD && !$NC.isNull(ITEM_BARCD)) {
                alert($NC.getDisplayMsg("JS.CMC04020E0.012", "상품바코드와 박스바코드에는 서로 다른 값을 입력하십시오."));
                $NC.setTabActiveIndex("#divRightView", 0);
                $NC.setGridSelectRow(G_GRDMASTER, row);
            ...
            if (ITEM_BARCD == CASE_BAR_CD && !$NC.isNull(ITEM_BARCD)) {
                alert($NC.getDisplayMsg("JS.CMC04020E0.013", "상품바코드와 소박스바코드에는 서로 다른 값을 입력하십시오."));
                $NC.setTabActiveIndex("#divRightView", 0);
                $NC.setGridSelectRow(G_GRDMASTER, row);
                $NC.setFocus("#edtItem_Bar_Cd");
                return false;
            ...
            if (BOX_BAR_CD == CASE_BAR_CD && !$NC.isNull(BOX_BAR_CD)) {
                alert($NC.getDisplayMsg("JS.CMC04020E0.014", "박스바코드와 소박스바코드에는 서로 다른 값을 입력하십시오."));
                $NC.setTabActiveIndex("#divRightView", 0);
                $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.isNotNull(rowData.OPEN_DATE) && $NC.isNotNull(rowData.CLOSE_DATE)) {
            if (rowData.CLOSE_DATE < rowData.OPEN_DATE) {
                alert($NC.getDisplayMsg("JS.CMC04020E0.015", "거래일자와 종료일자의 범위 입력오류입니다."));
                $NC.setTabActiveIndex("#divRightView", 0);
                $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.isNull(rowData.DEAL_DIV)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.016", "거래구분을 선택하십시오."));
            $NC.setTabActiveIndex("#divRightView", 0);
            $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.isNull(rowData.QTY_IN_BOX)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.017", "박스입수를 입력하십시오."));
            $NC.setTabActiveIndex("#divRightView", 0);
            $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.isNull(rowData.BOX_IN_PLT)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.018", "파렛트입수를 입력하십시오."));
        ...
        if ($NC.isNull(rowData.PLT_SPLIT_DIV)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.019", "파렛트분할을 선택하십시오."));
            $NC.setTabActiveIndex("#divRightView", 1);
            $NC.setGridSelectRow(G_GRDMASTER, row);
        ...
        if ($NC.isNull(rowData.SERIAL_IN_DIV)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.020", "입고일련번호관리구분을 선택하십시오."));
            $NC.setTabActiveIndex("#divRightView", 1);
            $NC.setFocus("#cboSerial_In_Div");
            return false;
        }
        if ($NC.isNull(rowData.SERIAL_OUT_DIV)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.021", "출고일련번호관리구분을 선택하십시오."));
            $NC.setTabActiveIndex("#divRightView", 1);
...
function grdMasterOnNewRecord(args) {
    ...
    $NC.setValueRadioGroup("#rgbDeal_Div", args.rowData.DEAL_DIV);
...
function grdMasterOnGetColumns() {
    ...
    $NC.setGridColumn(columns, {
        id: "RESTRICT_OUT_DAY",
        field: "RESTRICT_OUT_DAY",
        name: "출고제한일수",
        cssClass: "styRight"
    });
    $NC.setGridColumn(columns, {
        id: "IMMINENT_STOCK_DAY",
        field: "IMMINENT_STOCK_DAY",
        name: "임박재고전환기준일",
        cssClass: "styRight"
    });
    $NC.setGridColumn(columns, {
...
function grdMasterOnAfterScroll(e, args) {
    ...
    if ($NC.G_VAR.policyVal.CM310 == $ND.C_POLICY_VAL_3) {
        // 조회시 전역 변수 값 초기화
...
function grdMasterOnCellChange(e, args) {
    ...
    switch (args.col) {
        ...
        case "DEPART_CD":
            ...
            rowData.DEPART_CD_F = $NC.getValueCombo(args.view, "F");
            rowData.LINE_CD = "";
            rowData.LINE_CD_F = "";
            rowData.CLASS_CD = "";
            rowData.CLASS_CD_F = "";
        ...
        case "LINE_CD":
            ...
            rowData.LINE_CD_F = $NC.getValueCombo(args.view, "F");
            rowData.CLASS_CD = "";
            rowData.CLASS_CD_F = "";
            setClassCombo(rowData.LINE_CD, rowData.CLASS_CD);
            break;
        case "CLASS_CD":
            ...
            rowData.CLASS_CD_F = $NC.getValueCombo(args.view, "F");
            break;
        case "ITEM_BAR_CD":
            rowData.ITEM_BAR_CD = args.val;
            break;
        case "IDENTIFY_CD":
            rowData.IDENTIFY_CD = args.val;
            break;
        case "CASE_BAR_CD":
        ...
        case "QTY_IN_CASE":
            if ($NC.isNull(args.val)) {
                ...
                alert($NC.getDisplayMsg("JS.CMC04020E0.022", "소박스입수에 1이상의 정수를 입력하십시오."));
                rowData.QTY_IN_CASE = "1";
                $NC.setValue(args.view, rowData.QTY_IN_CASE);
        ...
        case "QTY_IN_BOX":
            if ($NC.isNull(args.val)) {
                ...
                alert($NC.getDisplayMsg("JS.CMC04020E0.023", "박스입수에 1이상의 정수를 입력하십시오."));
                rowData.QTY_IN_BOX = "1";
                $NC.setValue(args.view, rowData.QTY_IN_BOX);
                $NC.setFocus(args.view);
            } else {
        ...
        case "TERM_DIV":
            ...
            rowData.TERM_DIV_F = $NC.getValueCombo(args.view, "F");
            break;
        case "TERM_VAL":
            if ($NC.isNull(args.val)) {
                rowData.TERM_VAL = "0";
            ...
            break;
        case "LOT_NO_REQ_YN":
            rowData.LOT_NO_REQ_YN = args.val;
            break;
        case "VALID_DATE_REQ_YN":
            rowData.VALID_DATE_REQ_YN = args.val;
            break;
        case "BATCH_NO_REQ_YN":
            rowData.BATCH_NO_REQ_YN = args.val;
            break;
        case "LABELLING_DIV":
            rowData.LABELLING_DIV = args.val;
            rowData.LABELLING_DIV_F = $NC.getValueCombo(args.view, "F");
            break;
        case "BUY_PRICE":
            if ($NC.isNull(args.val)) {
                rowData.BUY_PRICE = "0";
        ...
        case "SET_ITEM_YN":
            ...
            break;
        case "SEASON_YN":
            rowData.SEASON_YN = args.val;
            break;
        case "WEIGHT_ITEM_YN":
            rowData.WEIGHT_ITEM_YN = args.val;
            break;
        case "DISCARD_PURCHASE_YN":
            rowData.DISCARD_PURCHASE_YN = args.val;
            break;
        case "DISCARD_SALE_YN":
            rowData.DISCARD_SALE_YN = args.val;
            break;
        case "SERIAL_IN_DIV":
        ...
        case "DEPT_CD":
            ...
            return;
        case "AGING_DIV":
            rowData.AGING_DIV = args.val;
            rowData.AGING_DIV_F = $NC.getValueCombo(args.view, "F");
            break;
        case "PROCURE_DIV":
            rowData.PROCURE_DIV = args.val;
            rowData.PROCURE_DIV_F = $NC.getValueCombo(args.view, "F");
            break;
        case "CLASS_DIV":
            rowData.CLASS_DIV = args.val;
            rowData.CLASS_DIV_F = $NC.getValueCombo(args.view, "F");
            break;
        case "RESTRICT_OUT_DAY":
            rowData.RESTRICT_OUT_DAY = args.val;
            break;
        case "IMMINENT_STOCK_DAY":
            rowData.IMMINENT_STOCK_DAY = args.val;
            break;
        case "DEAL_DIV1":
        case "DEAL_DIV2":
        case "DEAL_DIV3":
        ...
        case "OPEN_DATE":
            if ($NC.isNotNull(args.val)) {
                $NC.setValueDatePicker(args.view, args.val, $NC.getDisplayMsg("JS.CMC04020E0.024", "거래일자를 정확히 입력하십시오."));
            }
            rowData.OPEN_DATE = $NC.getValue(args.view);
            break;
        case "CLOSE_DATE":
            if ($NC.isNotNull(args.val)) {
                $NC.setValueDatePicker(args.view, args.val, $NC.getDisplayMsg("JS.CMC04020E0.025", "종료일자를 정확히 입력하십시오."));
            }
...
function grdDetailOnNewRecord(args) {
    ...
    $NC.setFocusGrid(G_GRDDETAIL, args.row, "ITEM_BARCD", true);
}
    ...
    switch (G_GRDDETAIL.view.getColumnId(args.cell)) {
        case "ITEM_BARCD":
            if ($NC.getGridSearchRows(G_GRDDETAIL, {
                ...
                searchVal: rowData.ITEM_BARCD
            }).length > 1) {
                alert($NC.getDisplayMsg("JS.CMC04020E0.026", "동일한 바코드가 존재합니다."));
                rowData.ITEM_BARCD = args.oldItem.ITEM_BARCD;
                $NC.setFocusGrid(G_GRDDETAIL, args.row, args.cell, true);
            }
            break;
        case "BARCD_QTY":
            if (Number(rowData.BARCD_QTY) <= 0) {
                alert($NC.getDisplayMsg("JS.CMC04020E0.027", "바코드수량은 0보다 큰 값을 입력 하십시오."));
                rowData.BARCD_QTY = args.oldItem.BARCD_QTY;
                $NC.setFocusGrid(G_GRDDETAIL, {
                    selectRow: args.row,
                    activeCell: "BARCD_QTY",
                    editMode: true
                });
            }
            break;
...
function grdDetailOnBeforePost(row) {
    ...
    if (rowData.CRUD != $ND.C_DV_CRUD_R) {
        if ($NC.isNull(rowData.ITEM_BARCD)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.028", "상품바코드를 입력하십시오."));
            $NC.setFocusGrid(G_GRDDETAIL, row, "ITEM_BARCD", true);
            return false;
        }
        if ($NC.isNull(rowData.BARCD_QTY)) {
            alert($NC.getDisplayMsg("JS.CMC04020E0.029", "바코드수량을 입력 하십시오."));
...
/**
 * 조회조건 대분류 combobox 설정
 */
function setQDepartCombo() {
...
/**
 * 조회조건 중분류 combobox 설정
 */
function setQLineCombo(LINE_CD) {
    ...
    $NC.setInitCombo("/WC/getDataSet.do", {
        ...
        addEmpty: true,
        onComplete: function() {
            $NC.setValue("#cboQLine_Cd", LINE_CD);
        }
    });
}

/**
 * 조회조건 소분류 combobox 설정
 */
function setQClassCombo(LINE_CD, CLASS_CD) {
    ...
    $NC.setInitCombo("/WC/getDataSet.do", {
        ...
        addEmpty: true,
        onComplete: function() {
            $NC.setValue("#cboQClass_Cd", CLASS_CD);
        }
    });
}
...
function setDepartCombo() {
    ...
    $NC.clearComboData("#cboDepart_Cd"); // 대분류 초기화
    ...
    $NC.clearComboData("#cboLine_Cd"); // 중분류 초기화
    $NC.clearComboData("#cboClass_Cd"); // 소분류 초기화
}
...
function btnBIItemRemoveOnClick() {
    ...
    if (G_GRDMASTER.data.getLength() == 0 || $NC.isNull(G_GRDMASTER.lastRow)) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.030", "이미지를 삭제할 상품을 선택 후 삭제처리 하십시오."));
        return;
    }

    var rowData = G_GRDMASTER.data.getItem(G_GRDMASTER.lastRow);
    if (rowData.CRUD == $ND.C_DV_CRUD_C || rowData.CRUD == $ND.C_DV_CRUD_N) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.031", "신규 데이터입니다. 저장 후 처리하십시오."));
        return;
    }

    if (!confirm($NC.getDisplayMsg("JS.CMC04020E0.032", "선택한 상품의 이미지를 삭제하시겠습니까?"))) {
        return;
    }
...
function btnBIItemUploadOnClick() {
    ...
    if (G_GRDMASTER.data.getLength() == 0 || $NC.isNull(G_GRDMASTER.lastRow)) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.033", "로고를 업로드할 상품을 선택 후 파일업로드 처리 하십시오."));
        return;
    }

    var rowData = G_GRDMASTER.data.getItem(G_GRDMASTER.lastRow);
    if (rowData.CRUD == $ND.C_DV_CRUD_C || rowData.CRUD == $ND.C_DV_CRUD_N) {
        alert($NC.getDisplayMsg("JS.CMC04020E0.032", "신규 데이터입니다. 저장 후 처리하십시오."));
        return;
    }
    ...
    $NC.showUploadFilePopup(".jpg, .png", function(view, fileFullName, fileName) {
        ...
        if (fileExt != "jpg" && fileExt != "png") {
            alert($NC.getDisplayMsg("JS.CMC04020E0.034", "이미지 파일(*.jpg, *.png) 파일을 선택하십시오."));
            return;
        }
...
function setPolicyValInfo() {
    ...
    $NC.setPolicyValInfo({
        ...
        if ($NC.G_VAR.policyVal.CM310 == $ND.C_POLICY_VAL_3) {
            $NC.setInitSplitter("#divLeftView", "hb", 200);
        } else {
            $NC.setVisible("#divDetail", false);
            $NC.onGlobalResize();
        }

        $NC.setVisible("#ctrSerialManagement", $NC.G_VAR.policyVal.CM490 == $ND.C_YES);
    });
}