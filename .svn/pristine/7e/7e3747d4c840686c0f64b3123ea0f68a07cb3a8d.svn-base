...
import nexos.service.cm.CMC03030E0Service;
 ...
 */
@Controller
@RequestMapping("/CMC03030E0")
public class CMC03030E0Controller extends ControllerSupport {

    @Autowired
    private CMC03030E0Service service;
    @Autowired
