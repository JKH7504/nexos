...
import nexos.dao.lc.LCC02030E0DAO;
...
/**
 * Class: LCC02030E0Service<br>
 * Description: 사업부이관관리(LCC02030E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC02030E0Service extends ServiceSupport {
    ...
    public String save(Map<String, Object> params) throws Exception {
        ...
        if (!Consts.PROCESS_ENTRY_CREATE.equals(processCd)) {
            ...
            checkParams.put("P_ETC_NO", dsMaster.get("P_ETC_NO"));
