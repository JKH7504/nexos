        ...
        // 기존 차수에 추가
            ...
            $NC.serviceCallAndWait("/LOM02010E0/getDataSet.do", {
                ...
                if (EQUIP_DIV != dsResult[0].EQUIP_DIV) {
                    alert($NC.getDisplayMsg("JS.LOM02010E0.065", "해당 차수는 다른 출하장비(" + dsResult[0].EQUIP_DIV_D + ")로 할당되어 추가 출고지시할 수 없습니다.",
...
function btnOrderGroupOnClick() {
    ...
    $NC.showProgramSubPopup({
        PROGRAM_ID: "LOM02012P0",
        PROGRAM_NM: $NC.getDisplayMsg("JS.LOM02010E0.001", "주문구성선택"),
        url: "lo/LOM02012P0.html",
        width: 900,
        height: 500,
        G_PARAMETER: {
            P_CENTER_CD: CENTER_CD,
