...
import nexos.service.lo.LOC05090E0Service;

/**
 * Class: 출고작업비등록 컨트롤러<br>
 * Description: 출고작업비등록 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOC05090E0")
public class LOC05090E0Controller extends ControllerSupport {

    @Autowired
    private LOC05090E0Service service;
