...
function _New() {
    ...
    switch ($NC.getValue("#cboInvest_Div")) {
        ...
        case "23":
            ...
            $NC.serviceCall("/LCC04010E0/getDataSet.do", {
                P_QUERY_ID: "LCC04010E0.RS_SUB23",
                P_QUERY_PARAMS: {
                    P_CENTER_CD: CENTER_CD,
                    P_BU_CD: BU_CD,
                    P_INOUT_DATE1: INOUT_DATE1,
