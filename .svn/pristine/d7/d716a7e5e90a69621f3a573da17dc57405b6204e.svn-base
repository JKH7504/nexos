...
import nexos.service.cs.CSC01050E0Service;

/**
 * Class: 권한그룹 프로그램관리 컨트롤러<br>
 * Description: 권한그룹 프로그램관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CSC01050E0")
public class CSC01050E0Controller extends ControllerSupport {

    @Autowired
    private CSC01050E0Service service;
