...
import nexos.dao.lc.LCC02050E0DAO;
...
/**
 * Class: LCC02050E0Service<br>
 * Description: 소분관리(LCC02050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC02050E0Service extends ServiceSupport {
