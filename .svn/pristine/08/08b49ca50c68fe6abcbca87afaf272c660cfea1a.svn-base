...
import nexos.service.lo.LOM01010E0Service;
 ...
 */
@Controller
@RequestMapping("/LOM01010E0")
public class LOM01010E0Controller extends ControllerSupport {

    @Autowired
    private LOM01010E0Service service;
