...
function _Initialize() {
    ...
    $("#btnQOutbound_Batch").click(function() { // 출고차수 재조회
        // 차수 새로고침
    ...
    $NC.setInitComboData({
        ...
        data: [
            {
                COMMON_CD: 0,
                COMMON_NM: $NC.getDisplayMsg("JS.LOC04010Q0.005", "전체")
            },
            {
                COMMON_CD: 1,
                COMMON_NM: $NC.getDisplayMsg("JS.LOC04010Q0.006", "결품발생상품")
            }
        ],
        onComplete: function() {
...
function _Inquiry() {
    ...
    if ($NC.isNull(CENTER_CD)) {
        alert($NC.getDisplayMsg("JS.LOC04010Q0.002", "물류센터를 선택하십시오."));
    ...
    if ($NC.isNull(OUTBOUND_DATE)) {
        alert($NC.getDisplayMsg("JS.LOC04010Q0.003", "출고일자를 입력하십시오."));
    ...
    if ($NC.isNull(VIEW_DIV)) {
        alert($NC.getDisplayMsg("JS.LOC04010Q0.004", "결품발생여부를 선택하십시오."));
