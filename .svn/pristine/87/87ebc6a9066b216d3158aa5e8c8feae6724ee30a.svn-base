...
import nexos.dao.lc.LCC02060E0DAO;
...
/**
 * Class: LCC02060E0Service<br>
 * Description: 품질검사처리(LCC02060E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC02060E0Service extends ServiceSupport {
    ...
    @Autowired
    private LCC02060E0DAO   dao;

    @Autowired
    private EDCommonService edCommonService;

    /**
     * 품질검사상태변환등록 - 기타입출고 등록 저장 처리
     *
     * @param params
     *        신규, 수정된 데이터
     */
