...
public class CSC01040E0DAOImpl extends DaoSupport implements CSC01040E0DAO {
    ...
    final String PROGRAM_ID                = "CSC01040E0";

    final String TABLE_NM_CSMENU           = "CSMENU";
    final String INSERT_ID_CSMENU          = PROGRAM_ID + ".INSERT_" + TABLE_NM_CSMENU;
    final String UPDATE_ID_CSMENU          = PROGRAM_ID + ".UPDATE_" + TABLE_NM_CSMENU;
    final String DELETE_ID_CSMENU          = PROGRAM_ID + ".DELETE_" + TABLE_NM_CSMENU;
    final String DELETE_ID_CSMENU_SUB_MENU = PROGRAM_ID + ".DELETE_" + TABLE_NM_CSMENU + "_SUB_MENU";
