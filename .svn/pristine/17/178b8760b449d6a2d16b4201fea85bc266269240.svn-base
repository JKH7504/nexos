...
/**
 * Class: LFC05020E0DAOImpl<br>
 * Description: LFC05020E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05020E0DAO")
public class LFC05020E0DAOImpl extends DaoSupport implements LFC05020E0DAO {

    final String PROGRAM_ID        = "LFC05020E0";

    final String TABLE_NM_LF120NM  = "LF120NM";
    final String UPDATE_ID_LF120NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF120NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF120NM, rowData);
            }
        }
    }
}
