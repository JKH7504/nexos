...
/**
 * Class: LFC05090E0DAOImpl<br>
 * Description: LFC05090E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05090E0DAO")
public class LFC05090E0DAOImpl extends DaoSupport implements LFC05090E0DAO {

    final String PROGRAM_ID        = "LFC05090E0";

    final String TABLE_NM_LF250NM  = "LF250NM";
    final String UPDATE_ID_LF250NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF250NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF250NM, rowData);
            }
        }
    }
}
