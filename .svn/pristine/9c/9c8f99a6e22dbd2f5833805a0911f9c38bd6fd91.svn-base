...
import nexos.service.li.LIC05050E0Service;

/**
 * Class: 입고시리얼처리 컨트롤러<br>
 * Description: 입고시리얼처리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LIC05050E0")
public class LIC05050E0Controller extends ControllerSupport {

    @Autowired
    private LIC05050E0Service service;
