...
import nexos.service.ri.RIM05050E0Service;

/**
 * Class: 반입시리얼처리 컨트롤러<br>
 * Description: 반입시리얼처리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/RIM05050E0")
public class RIM05050E0Controller extends ControllerSupport {

    @Autowired
    private RIM05050E0Service service;
