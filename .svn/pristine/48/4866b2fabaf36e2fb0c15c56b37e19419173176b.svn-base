...
import nexos.service.lc.LCC02060E0Service;

/**
 * Class: 품질검사처리 컨트롤러<br>
 * Description: 품질검사처리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LCC02060E0")
public class LCC02060E0Controller extends ControllerSupport {

    final String              SP_ID_GET_LC_CONFIRM_YN = "WF.GET_LC_CONFIRM_YN";

    @Autowired
    private LCC02060E0Service service;
