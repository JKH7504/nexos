...
/**
 * Class: LOM02010E0DAOImpl<br>
 * Description: LOM02010E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LOM02010E0DAO")
public class LOM02010E0DAOImpl extends DaoSupport implements LOM02010E0DAO {

    // private final Logger logger = LoggerFactory.getLogger(LOM02010E0DAOImpl.class);

    final String PROGRAM_ID                      = "LOM02010E0";
    final String PROGRAM_ID_LOB01010E0           = "LOB01010E0";
    final String PROGRAM_ID_LOB02010E0           = "LOB02010E0";
    ...
    final String INSERT_ID_LO020NM               = PROGRAM_ID_LOB02010E0 + ".INSERT_" + TABLE_NM_LO020NM;
    final String UPDATE_ID_LO020NM               = PROGRAM_ID_LOB02010E0 + ".UPDATE_" + TABLE_NM_LO020NM;

    final String TABLE_NM_LO020ND                = "LO020ND";
    final String INSERT_ID_LO020ND               = PROGRAM_ID_LOB02010E0 + ".INSERT_" + TABLE_NM_LO020ND;
    final String UPDATE_ID_LO020ND               = PROGRAM_ID_LOB02010E0 + ".UPDATE_" + TABLE_NM_LO020ND;
    final String DELETE_ID_LO020ND               = PROGRAM_ID_LOB02010E0 + ".DELETE_" + TABLE_NM_LO020ND;

    final String TABLE_NM_LO030NM                = "LO030NM";
    final String UPDATE_ID_LO030NM               = PROGRAM_ID_LOB02010E0 + ".UPDATE_" + TABLE_NM_LO030NM;
    ...
    private void checkingPStockQty(Map<String, Object> rowData, int rownum) {
        ...
        if (sumEntryQty > pstockQty) {
            String errMsg = NexosMessage.getDisplayMsg("JAVA.LOM02010E0.001",
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        if (Consts.PROCESS_ORDER.equals(PROCESS_CD) || Consts.PROCESS_ENTRY_CREATE.equals(PROCESS_CD)) {
            ...
            if (dsCount < 1) {
                throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOM02010E0.002", "출고등록 상세내역이 존재하지 않습니다."));
            }
        ...
        for (int i = 0; i < dsCount; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                if (updateSql(UPDATE_ID_LO020ND, rowData) == 0) {
                    throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOM02010E0.003", "출고확정된 전표만 미배송 저장 처리가 가능합니다."));
                }
            }
        }
    }
        ...
        for (int i = 0; i < dsCount; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                if (updateSql(UPDATE_ID_LO010ND, rowData) == 0) {
                    throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOM02010E0.004",
