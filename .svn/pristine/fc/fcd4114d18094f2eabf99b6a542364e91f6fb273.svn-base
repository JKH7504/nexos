...
public class RIB02010E0DAOImpl extends DaoSupport implements RIB02010E0DAO {
    ...
    final String PROGRAM_ID                   = "RIB02010E0";

    final String TABLE_NM_RI020NM             = "RI020NM";
    final String INSERT_ID_RI020NM            = PROGRAM_ID + ".INSERT_" + TABLE_NM_RI020NM;
    final String UPDATE_ID_RI020NM            = PROGRAM_ID + ".UPDATE_" + TABLE_NM_RI020NM;
    final String DELETE_ID_RI020NM            = PROGRAM_ID + ".DELETE_" + TABLE_NM_RI020NM;

    final String TABLE_NM_RI020ND             = "RI020ND";
    final String INSERT_ID_RI020ND            = PROGRAM_ID + ".INSERT_" + TABLE_NM_RI020ND;
    final String UPDATE_ID_RI020ND            = PROGRAM_ID + ".UPDATE_" + TABLE_NM_RI020ND;
    final String DELETE_ID_RI020ND            = PROGRAM_ID + ".DELETE_" + TABLE_NM_RI020ND;

    final String TABLE_NM_RI030NM             = "RI030NM";
    final String UPDATE_ID_RI030NM            = PROGRAM_ID + ".UPDATE_" + TABLE_NM_RI030NM;
