...
/**
 * Class: LOB07020E0DAOImpl<br>
 * Description: LOB07020E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LOB07020E0DAO")
public class LOB07020E0DAOImpl extends DaoSupport implements LOB07020E0DAO {

    final String PROGRAM_ID                      = "LOB07020E0";
    ...
    public void returnSave(Map<String, Object> params) throws Exception {
        ...
        if (dsCnt < 1) {
            throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOB07020E0.001", "반입예정등록 상세내역이 존재하지 않습니다."));
        }
