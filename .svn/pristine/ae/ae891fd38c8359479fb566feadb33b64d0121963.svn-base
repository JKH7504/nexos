...
import nexos.service.ri.RIB02010E0Service;
 ...
 */
@Controller
@RequestMapping("/RIB02010E0")
public class RIB02010E0Controller extends ControllerSupport {

    @Autowired
    private RIB02010E0Service service;
