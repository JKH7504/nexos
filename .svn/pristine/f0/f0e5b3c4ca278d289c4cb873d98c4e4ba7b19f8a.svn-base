...
function _Inquiry() {
    ...
    // 데이터 조회
    $NC.serviceCall("/PDA_LIC02370E0/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster, onError);
}
...
function grdMasterOnAfterScroll(e, args) {
    ...
    if (lastRowData.CRUD == $ND.C_DV_CRUD_U || $NC.isGridModified(G_GRDDETAIL)) {
        ...
        alert($NC.getDisplayMsg("JS.PDA_LIC02370E0.017", "입력한 작업수량을 저장 후 진행하십시오."));
