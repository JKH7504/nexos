...
import nexos.service.scan.SCAN_LOF03010E0Service;

/**
 * Class: 출고 스캔검수(B2CF) 컨트롤러<br>
 * Description: 출고 스캔검수(B2CF) Controller<br>
 ...
 */
@Controller
@RequestMapping("/SCAN_LOF03010E0")
public class SCAN_LOF03010E0Controller extends ControllerSupport {

    @Autowired
    private SCAN_LOF03010E0Service service;
