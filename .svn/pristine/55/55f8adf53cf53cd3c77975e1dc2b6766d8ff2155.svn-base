...
import nexos.service.cm.CMC07010E0Service;
 ...
 */
@Controller
@RequestMapping("/CMC07010E0")
public class CMC07010E0Controller extends ControllerSupport {

    @Autowired
    private CMC07010E0Service service;
