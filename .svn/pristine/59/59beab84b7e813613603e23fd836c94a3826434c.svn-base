...
import nexos.service.lc.LCC04010E0Service;
 ...
 */
@Controller
@RequestMapping("/LCC04010E0")
public class LCC04010E0Controller extends ControllerSupport {

    final String              SP_ID_GET_LC_CONFIRM_YN = "WF.GET_LC_CONFIRM_YN";

    @Autowired
    private LCC04010E0Service service;
    ...
    @RequestMapping(value = "/callLcInvestConfirm.do", method = RequestMethod.POST)
    public ResponseEntity<String> callLcInvestConfirm(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callLcInvestConfirm(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
    ...
    public ResponseEntity<String> callLcFwInvestReplectConfirm(HttpServletRequest request, @RequestBody Map<String, Object> params) {
