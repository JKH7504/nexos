...
import nexos.service.lo.LOB04010E0Service;
 ...
 */
@Controller
@RequestMapping("/LOB04010E0")
public class LOB04010E0Controller extends ControllerSupport {

    @Autowired
    private LOB04010E0Service service;
