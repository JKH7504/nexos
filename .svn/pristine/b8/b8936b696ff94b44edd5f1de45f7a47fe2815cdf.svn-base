...
public class DatabaseConfig {
    ...
    /**
     * 기본 DataSource(Connection Pool) Bean
     *
     * @return
     * @throws Exception
     */
    ...
    public ComboPooledDataSource dataSource() throws Exception {
        ...
        int initialPoolSize = Math.max(Util.toInt(globalProps.getProperty("DB.INITIAL_POOL_SIZE"), 5), 5);
    ...
    /**
     * myBatis SqlSessionFactory Bean<br>
     * Mapper Reload를 위해 SqlSessionFactory가 아닌 SqlSessionFactoryBean을 리턴
     *
     * @param dataSource
     * @return
     * @throws Exception
    ...
    /**
     * Transaction 처리를 위한 TransactionManager Bean
     *
     * @param dataSource
     * @return
     * @throws Exception
