...
import nexos.service.lo.LOM07020E0Service;

/**
 * Class: 온라인운송장내역 컨트롤러<br>
 * Description: 온라인운송장내역 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOM07020E0")
public class LOM07020E0Controller extends ControllerSupport {

    @Autowired
    private LOM07020E0Service service;
