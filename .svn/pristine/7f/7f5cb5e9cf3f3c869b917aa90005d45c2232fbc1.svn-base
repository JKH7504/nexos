...
/**
 * Class: EDR05010E0Service<br>
 * Description: [수신]반입예정 관리(EDR05010E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class EDR05010E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(EDR05010E0Service.class);
