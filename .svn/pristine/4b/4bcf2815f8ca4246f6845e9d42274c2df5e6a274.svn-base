 ...
 *          </pre>
 */
@Repository("PDA_LCC03010E0DAO")
public class PDA_LCC03010E0DAOImpl extends DaoSupport implements PDA_LCC03010E0DAO {

    final String PROGRAM_ID         = "PDA_LCC03010E0";
