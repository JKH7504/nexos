...
import nexos.service.cm.CMC04110E0Service;

/**
 * Class: 자재관리 컨트롤러<br>
 * Description: 자재관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CMC04110E0")
public class CMC04110E0Controller extends ControllerSupport {

    @Autowired
    private CMC04110E0Service service;
