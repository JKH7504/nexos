...
import nexos.dao.pda.PDA_LIC02320E0DAO;
...
/**
 * Class: PDA_LIC02320E0Service<br>
 * Description: PDA 입고검수(멀티상품매핑) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class PDA_LIC02320E0Service extends ServiceSupport {

    @Autowired
    private PDA_LIC02320E0DAO dao;
    ...
    public Map<String, Object> callLIProcInspectT2(Map<String, Object> params) throws Exception {
        ...
        try {
            resultMap = dao.callLIProcInspectT2(params);
