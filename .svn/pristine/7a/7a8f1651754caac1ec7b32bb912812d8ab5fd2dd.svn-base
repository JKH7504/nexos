...
import nexos.dao.lc.LCC03020E0DAO;
...
/**
 * Class: LCC03020E0Service<br>
 * Description: 파렛트ID병합관리(LCC03020E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC03020E0Service extends ServiceSupport {
    ...
    final String          SP_ID_LC_FW_PLTID_MERGE_CONFIRM = "LC_FW_PLTID_MERGE_CONFIRM";

    @Autowired
    private LCC03020E0DAO dao;
     ...
     */
    public Map<String, Object> callLCBwPltIdMergeEntry(Map<String, Object> params) throws Exception {

        Map<String, Object> resultMap;

        TransactionStatus ts = beginTrans();
        try {
            resultMap = callProcedure(SP_ID_LC_BW_PLTID_MERGE_ENTRY, params);
     ...
     * SP 실행 후 처리 결과를 Map 형태로 Return
     */
    public Map<String, Object> callLCPltIdMergeConfrim(Map<String, Object> params) throws Exception {

        Map<String, Object> resultMap;

        TransactionStatus ts = beginTrans();
        try {
            resultMap = callProcedure(SP_ID_LC_FW_PLTID_MERGE_CONFIRM, params);
