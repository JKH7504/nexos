 ...
 *  ==================================================================================================================================================
 *  프로그램ID         : RIC03010Q0
 *  프로그램명         : 반입진행현황[B2B/B2C]
 *  프로그램설명       : 반입진행현황[B2B/B2C] 화면 Javascript
...
function _OnConditionChange(e, view, val) {
    ...
    switch (id) {
        ...
        case "BRAND_CD":
            ...
            if ($NC.isNull(BU_CD)) {
                alert($NC.getDisplayMsg("JS.RIC03010Q0.001", "사업부를 먼저 선택 하십시오."));
                $NC.setValue("#edtQBrand_Cd");
        ...
        case "DELIVERY_CD":
            ...
            return;
        case "INBOUND_DATE1":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.RIC03010Q0.002", "검색 시작일자를 정확히 입력하십시오."));
            break;
        case "INBOUND_DATE2":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.RIC03010Q0.003", "검색 종료일자를 정확히 입력하십시오."));
            break;
    }
...
function _Inquiry() {
    ...
    if ($NC.getTabActiveIndex("#divMasterView") == 0) {
        ...
        // 데이터 조회
        $NC.serviceCall("/RIC03010Q0/getDataSet.do", $NC.getGridParams(G_GRDT1MASTER), onGetT1Master);
        ...
        // 데이터 조회
        $NC.serviceCall("/RIC03010Q0/getDataSet.do", $NC.getGridParams($NC.G_VAR.activeView.grdMaster), onGetT2Master);
    } else {
        // 상세 반입진행내역 화면
        // 조회시 전역 변수 값 초기화
        ...
        // 데이터 조회
        $NC.serviceCall("/RIC03010Q0/getDataSet.do", $NC.getGridParams(G_GRDT3MASTER), onGetT3Master);
    }
}
...
function grdT1MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT1Master", {
        ...
        queryId: "RIC03010Q0.RS_T1_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT2MasterOnAfterScroll(e, args) {
    ...
    // 데이터 조회
    $NC.serviceCall("/RIC03010Q0/getDataSet.do", $NC.getGridParams($NC.G_VAR.activeView.grdDetail), onGetT2Detail);
...
function grdT2MasterAInitialize() {
    ...
    $NC.setInitGridObject("#grdT2MasterA", {
        ...
        queryId: "RIC03010Q0.RS_T2_MASTER",
...
function grdT2DetailAInitialize() {
    ...
    $NC.setInitGridObject("#grdT2DetailA", {
        ...
        queryId: "RIC03010Q0.RS_T2_DETAIL",
        sortCol: "LINE_NO",
        gridOptions: options
    });
...
function grdT3MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT3Master", {
        ...
        queryId: "RIC03010Q0.RS_T3_MASTER",
        sortCol: "BU_CD",
        gridOptions: options
    });
...
function setSubSummaryInfo() {
    ...
    // 데이터 조회
    $NC.serviceCall("/RIC03010Q0/getDataSet.do", {
        P_QUERY_ID: "RIC03010Q0.RS_T2_SUB",
        P_QUERY_PARAMS: {
            P_CENTER_CD: CENTER_CD,
            P_INBOUND_DATE1: INBOUND_DATE1,
            P_INBOUND_DATE2: INBOUND_DATE2,
