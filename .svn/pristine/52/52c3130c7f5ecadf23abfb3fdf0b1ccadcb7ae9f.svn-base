...
import nexos.service.ri.RIB05050E0Service;
 ...
 */
@Controller
@RequestMapping("/RIB05050E0")
public class RIB05050E0Controller extends ControllerSupport {

    @Autowired
    private RIB05050E0Service service;
