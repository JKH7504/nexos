...
public class LIC05010E0DAOImpl extends DaoSupport implements LIC05010E0DAO {
    ...
    final String PROGRAM_ID        = "LIC05010E0";

    final String TABLE_NM_LI030NM  = "LI030NM";
    final String INSERT_ID_LI030NM = PROGRAM_ID + ".INSERT_" + TABLE_NM_LI030NM;
    final String UPDATE_ID_LI030NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LI030NM;
    final String DELETE_ID_LI030NM = PROGRAM_ID + ".DELETE_" + TABLE_NM_LI030NM;
