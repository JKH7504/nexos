...
import nexos.service.lo.LOB05020E0Service;
 ...
 */
@Controller
@RequestMapping("/LOB05020E0")
public class LOB05020E0Controller extends ControllerSupport {

    @Autowired
    private LOB05020E0Service service;
