...
/**
 * Class: LOM01010E0DAOImpl<br>
 * Description: LOM01010E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LOM01010E0DAO")
public class LOM01010E0DAOImpl extends DaoSupport implements LOM01010E0DAO {

    final String PROGRAM_ID              = "LOM01010E0";
    final String PROGRAM_ID_LOB01010E0   = "LOB01010E0";

    final String TABLE_NM_LO010NM        = "LO010NM";
    final String INSERT_ID_LO010NM       = PROGRAM_ID_LOB01010E0 + ".INSERT_" + TABLE_NM_LO010NM;
    final String UPDATE_ID_LO010NM       = PROGRAM_ID_LOB01010E0 + ".UPDATE_" + TABLE_NM_LO010NM;
    final String DELETE_ID_LO010NM       = PROGRAM_ID_LOB01010E0 + ".DELETE_" + TABLE_NM_LO010NM;

    final String TABLE_NM_LO010ND        = "LO010ND";
    final String INSERT_ID_LO010ND       = PROGRAM_ID_LOB01010E0 + ".INSERT_" + TABLE_NM_LO010ND;
    final String UPDATE_ID_LO010ND       = PROGRAM_ID_LOB01010E0 + ".UPDATE_" + TABLE_NM_LO010ND;
    final String DELETE_ID_LO010ND       = PROGRAM_ID_LOB01010E0 + ".DELETE_" + TABLE_NM_LO010ND;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        if (Consts.PROCESS_ORDER_CREATE.equals(processCd)) {
            ...
            if (dsCnt < 1) {
                throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOM01010E0.001", "출고예정등록 상세내역이 존재하지 않습니다."));
            }
