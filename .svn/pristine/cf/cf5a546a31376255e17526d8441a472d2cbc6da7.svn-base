...
import nexos.service.lo.LOM01020Q0Service;;
 ...
 */
@Controller
@RequestMapping("/LOM01020Q0")
public class LOM01020Q0Controller extends ControllerSupport {

    @Autowired
    private LOM01020Q0Service service;
