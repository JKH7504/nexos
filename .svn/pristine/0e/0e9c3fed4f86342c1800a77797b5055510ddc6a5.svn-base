...
import nexos.service.pda.PDA_LCC03030E0Service;

/**
 * Class: PDA_LCC03030E0Controller<br>
 * Description: PDA 재고이동(멀티) 컨트롤러<br>
 ...
 */
@Controller
@RequestMapping("/PDA_LCC03030E0")
public class PDA_LCC03030E0Controller extends ControllerSupport {

    @Autowired
    private PDA_LCC03030E0Service service;
