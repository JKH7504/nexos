...
import nexos.service.ed.EDR03010E0Service;
 ...
 */
@Controller
@RequestMapping("/EDR03010E0")
public class EDR03010E0Controller extends ControllerSupport {

    @Autowired
    private EDR03010E0Service service;
     ...
     *        조회조건
     */
    @RequestMapping(value = "/callERLIOrderDelete.do", method = RequestMethod.POST)
    public ResponseEntity<String> callERLIOrderDelete(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callERLIOrderDelete(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
