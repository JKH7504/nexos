...
import nexos.service.ed.EDR05020E0Service;
import nexos.service.ed.common.EDCommonService;

/**
 * Class: [수신]반입취소 관리<br>
 * Description: [수신]반입취소 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/EDR05020E0")
public class EDR05020E0Controller extends ControllerSupport {

    @Autowired
    private EDR05020E0Service service;
     ...
     *        조회조건
     */
    @RequestMapping(value = "/callERRIOrderDelete.do", method = RequestMethod.POST)
    public ResponseEntity<String> callERRIOrderDelete(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callERRIOrderDelete(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
