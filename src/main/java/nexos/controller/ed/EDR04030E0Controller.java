...
import nexos.service.ed.EDR04030E0Service;
 ...
 */
@Controller
@RequestMapping("/EDR04030E0")
public class EDR04030E0Controller extends ControllerSupport {

    @Autowired
    private EDR04030E0Service service;
     ...
     *        조회조건
     */
    @RequestMapping(value = "/callERLOMallOrderDelete.do", method = RequestMethod.POST)
    public ResponseEntity<String> callERLOMallOrderDelete(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callERLOMallOrderDelete(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
