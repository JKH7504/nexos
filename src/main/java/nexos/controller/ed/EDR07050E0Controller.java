...
import nexos.service.ed.EDR07050E0Service;
import nexos.service.ed.common.EDCommonService;

/**
 * Class: [수신]기타입출고예정 관리<br>
 * Description: [수신]기타입출고예정 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/EDR07050E0")
public class EDR07050E0Controller extends ControllerSupport {

    @Autowired
    private EDR07050E0Service service;
     ...
     *        조회조건
     */
    @RequestMapping(value = "/callERLCOrderDelete.do", method = RequestMethod.POST)
    public ResponseEntity<String> callERLCOrderDelete(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callERLCOrderDelete(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
