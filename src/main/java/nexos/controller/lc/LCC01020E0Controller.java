...
import nexos.service.lc.LCC01020E0Service;

/**
 * Class: 세트예정등록 컨트롤러<br>
 * Description: 세트예정등록 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LCC01020E0")
public class LCC01020E0Controller extends ControllerSupport {

    final String              SP_ID_GET_LC_CONFIRM_YN = "WF.GET_LC_CONFIRM_YN";

    @Autowired
    private LCC01020E0Service service;
     ...
     * @param params
     */
    @RequestMapping(value = "/callLcOrderDelete.do", method = RequestMethod.POST)
    public ResponseEntity<String> callLcOrderDelete(HttpServletRequest request, @RequestBody Map<String, Object> params) {

        ResponseEntity<String> result = null;

        try {
            result = getResponseEntity(request, service.callLcOrderDelete(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
