...
import nexos.service.lc.LCC02030E0Service;
 ...
 */
@Controller
@RequestMapping("/LCC02030E0")
public class LCC02030E0Controller extends ControllerSupport {

    final String              SP_ID_GET_LC_CONFIRM_YN = "WF.GET_LC_CONFIRM_YN";

    @Autowired
    private LCC02030E0Service service;
    ...
    public ResponseEntity<String> save(HttpServletRequest request, @RequestBody Map<String, Object> params) {
        ...
        ResponseEntity<String> result = null; // 수정추가
