...
import nexos.service.lc.LCC02050E0Service;

/**
 * Class: 소분관리 컨트롤러<br>
 * Description: 소분관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LCC02050E0")
public class LCC02050E0Controller extends ControllerSupport {

    final String              SP_ID_GET_LC_CONFIRM_YN = "WF.GET_LC_CONFIRM_YN";

    @Autowired
    private LCC02050E0Service service;
