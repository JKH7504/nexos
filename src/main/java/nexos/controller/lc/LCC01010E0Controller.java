...
import nexos.service.lc.LCC01010E0Service;
 ...
 */
@Controller
@RequestMapping("/LCC01010E0")
public class LCC01010E0Controller extends ControllerSupport {

    final String              SP_ID_GET_LC_CONFIRM_YN = "WF.GET_LC_CONFIRM_YN";

    @Autowired
    private LCC01010E0Service service;
