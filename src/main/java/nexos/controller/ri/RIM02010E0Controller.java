...
import nexos.service.ri.RIM02010E0Service;
 ...
 */
@Controller
@RequestMapping("/RIM02010E0")
public class RIM02010E0Controller extends ControllerSupport {

    @Autowired
    private RIM02010E0Service service;
    ...
    public ResponseEntity<String> callRIProcessing(HttpServletRequest request, @RequestBody Map<String, Object> params) {
    ...
    public ResponseEntity<String> callRIEntryProcessing(HttpServletRequest request, @RequestBody Map<String, Object> params) {
