...
import nexos.service.cm.CMC05080Q0Service;

/**
 * Class: 적재파렛트출력 컨트롤러<br>
 * Description: 적재파렛트출력 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CMC05080Q0")
public class CMC05080Q0Controller extends ControllerSupport {

    @Autowired
    private CMC05080Q0Service service;
