...
import nexos.service.cm.CMC04020E0Service;
 ...
 */
@Controller
@RequestMapping("/CMC04020E0")
public class CMC04020E0Controller extends ControllerSupport {

    @Autowired
    private CMC04020E0Service service;
     ...
     * @param imageCd1
     * @param imageCd2
     * @return OutputStream으로 이미지 문서를 리턴
     */
