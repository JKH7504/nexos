...
import nexos.service.ro.ROC05090E0Service;

/**
 * Class: 반출작업비등록 컨트롤러<br>
 * Description: 반출작업비등록 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ROC05090E0")
public class ROC05090E0Controller extends ControllerSupport {

    @Autowired
    private ROC05090E0Service service;
