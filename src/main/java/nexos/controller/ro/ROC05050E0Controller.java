...
import nexos.service.ro.ROC05050E0Service;

/**
 * Class: 반출시리얼처리 컨트롤러<br>
 * Description: 반출시리얼처리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ROC05050E0")
public class ROC05050E0Controller extends ControllerSupport {

    @Autowired
    private ROC05050E0Service service;
