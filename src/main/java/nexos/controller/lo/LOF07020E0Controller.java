...
import nexos.service.lo.LOF07020E0Service;

/**
 * Class: 운송장내역[B2CF] 컨트롤러<br>
 * Description: 운송장내역[B2CF] Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOF07020E0")
public class LOF07020E0Controller extends ControllerSupport {

    @Autowired
    private LOF07020E0Service service;
