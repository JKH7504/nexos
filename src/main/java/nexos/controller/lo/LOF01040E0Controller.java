...
import nexos.service.lo.LOF01040E0Service;

/**
 * Class: 풀필먼트 출고예정병합 컨트롤러<br>
 * Description: 풀필먼트 출고예정병합 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOF01040E0")
public class LOF01040E0Controller extends ControllerSupport {

    @Autowired
    private LOF01040E0Service service;
