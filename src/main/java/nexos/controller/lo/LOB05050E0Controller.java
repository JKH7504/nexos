...
import nexos.service.lo.LOB05050E0Service;

/**
 * Class: 출고시리얼처리 컨트롤러<br>
 * Description: 출고시리얼처리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOB05050E0")
public class LOB05050E0Controller extends ControllerSupport {

    @Autowired
    private LOB05050E0Service service;
