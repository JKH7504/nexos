...
import nexos.service.lo.LOM05050E0Service;
 ...
 */
@Controller
@RequestMapping("/LOM05050E0")
public class LOM05050E0Controller extends ControllerSupport {

    @Autowired
    private LOM05050E0Service service;
