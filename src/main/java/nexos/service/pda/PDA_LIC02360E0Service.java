...
import nexos.dao.pda.PDA_LIC02360E0DAO;
...
/**
 * Class: PDA_LIC02360E0Service<br>
 * Description: PDA 입고적치(멀티상품매핑) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class PDA_LIC02360E0Service extends ServiceSupport {

    @Autowired
    private PDA_LIC02360E0DAO dao;
    ...
    public Map<String, Object> callLIProcPutawayT2(Map<String, Object> params) throws Exception {
        ...
        try {
            resultMap = dao.callLIProcPutawayT2(params);
