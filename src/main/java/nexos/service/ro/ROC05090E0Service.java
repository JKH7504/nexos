...
import nexos.dao.ro.ROC05090E0DAO;
import nexos.framework.Consts;
import nexos.framework.Util;
import nexos.framework.support.ServiceSupport;

/**
 * Class: ROC05090E0Service<br>
 * Description: 반출작업비등록(ROC05090E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class ROC05090E0Service extends ServiceSupport {

    final String          SP_ID_GET_PROTECT = "WF.GET_PROTECT";

    @Autowired
    private ROC05090E0DAO dao;
    ...
    public String save(Map<String, Object> params) throws Exception {
        ...
        callParams.put("P_PROTECT_DATE", checkRow.get("P_OUTBOUND_DATE"));
