...
import nexos.dao.cs.CSC01050E0DAO;
import nexos.framework.Consts;
import nexos.framework.Util;
import nexos.framework.support.ServiceSupport;

/**
 * Class: CSC01050E0Service<br>
 * Description: 권한그룹프로그램관리 내역 조회(CSC01050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class CSC01050E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(CSC01050E0Service.class);
    @Autowired
    private CSC01050E0DAO dao;
