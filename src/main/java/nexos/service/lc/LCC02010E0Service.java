...
import nexos.dao.lc.LCC02010E0DAO;
...
/**
 * Class: LCC02010E0Service<br>
 * Description: 상태변환관리(LCC02010E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC02010E0Service extends ServiceSupport {
    ...
    public Map<String, Object> callLCFWStateChangeEntry(Map<String, Object> params) throws Exception {
        ...
        TransactionStatus ts = beginTrans();
        try {
            result = dao.callLCFWStateChangeEntry(params);
