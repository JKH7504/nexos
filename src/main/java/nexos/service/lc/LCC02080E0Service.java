...
import nexos.dao.lc.LCC02080E0DAO;
...
/**
 * Class: LCC02080E0Service<br>
 * Description: 라벨링작업관리(LCC02080E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LCC02080E0Service extends ServiceSupport {
    ...
    public Map<String, Object> callLCFWLabellingOrder(Map<String, Object> params) throws Exception {
        ...
        TransactionStatus ts = beginTrans();
        try {
            resultMap = dao.callLCFWLabellingOrder(params);
            String oMsg = Util.getOutMessage(resultMap);
            // 오류면 Rollback
            if (!Consts.OK.equals(oMsg)) {
                throw new RuntimeException(oMsg);
