...
import nexos.dao.lo.LOB07020E0DAO;
...
/**
 * Class: LOB07020E0Service<br>
 * Description: 운송장내역(LOB07020E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LOB07020E0Service extends ServiceSupport {

    final String          SP_ID_GET_LO_OUTBOUND_STATE = "WF.GET_LO_OUTBOUND_STATE";

    @Autowired
    private LOB07020E0DAO dao;
