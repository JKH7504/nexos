...
import nexos.dao.lo.LOM05050E0DAO;
...
/**
 * Class: LOM05050E0Service<br>
 * Description: 출고시리얼처리(LOM05050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LOM05050E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(LOM05050E0Service.class);

    final String          SP_ID_GET_LO_OUTBOUND_STATE = "WF.GET_LO_OUTBOUND_STATE";

    @Autowired
    private LOM05050E0DAO dao;
