 ...
 */
@Service
public class LOB08010E0Service extends ServiceSupport {

    final String SP_ID_CREATE_ASSORT_INIT = "WB.CREATE_ASSORT_INIT";
    final String SP_ID_CREATE_SOLID_INIT  = "WB.CREATE_SOLID_INIT";
     ...
     *        수정된 데이터
     */
    public Map<String, Object> callCreateAssortInit(Map<String, Object> params) throws Exception {
        ...
        try {
            String spId = null;
            if ("40".equals(params.get("P_EQUIP_DIV"))) { // 40 어소트
                spId = SP_ID_CREATE_ASSORT_INIT;
            } else {
                spId = SP_ID_CREATE_SOLID_INIT; // 50 솔리드
            }

            resultMap = callProcedure(spId, params);
