...
import nexos.dao.lo.LOF01010E0DAO;
...
/**
 * Class: LOF01010E0Service<br>
 * Description: 온라인 출고예정작업[풀필먼트](LOF01010E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LOF01010E0Service extends ServiceSupport {
        ...
        try {
            ...
            if (Consts.OK.equals(oMsg)) {
                ...
                if (!Consts.YES.equals(orderYn)) {
                    result = NexosMessage.getDisplayMsg("JAVA.LOF01010E0SERVICE.001", "[발주마감시간 : " + deadlineTime + "] 출고예정 등록 가능한 시간이 아닙니다.",
                        new String[] {deadlineTime});
                }
            }
        } catch (Exception e) {
            result = NexosMessage.getDisplayMsg("JAVA.LOF01010E0SERVICE.002", "발주마감시간을 확인할 수 없습니다.\n\n") + e.getMessage();
        }
