...
import nexos.dao.ri.RIM05050E0DAO;
...
/**
 * Class: RIM05050E0Service<br>
 * Description: 반입시리얼처리(RIM05050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class RIM05050E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(RIM05050E0Service.class);

    final String          SP_ID_GET_RI_INBOUND_STATE = "WF.GET_RI_INBOUND_STATE";

    @Autowired
    private RIM05050E0DAO dao;
    ...
    public String save(Map<String, Object> params) throws Exception {
        ...
        String checkState = (String)checkParams.get("P_INBOUND_STATE");
