...
import nexos.dao.ri.RIB02010E0DAO;
...
/**
 * Class: RIB02010E0Service<br>
 * Description: 반입작업(RIB02010E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class RIB02010E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(RIB02010E0Service.class);
