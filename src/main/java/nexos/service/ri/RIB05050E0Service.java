...
import nexos.dao.ri.RIB05050E0DAO;
...
/**
 * Class: RIB05050E0Service<br>
 * Description: 반입시리얼처리(RIB05050E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class RIB05050E0Service extends ServiceSupport {

    // private final Logger logger = LoggerFactory.getLogger(RIB05050E0Service.class);

    final String          SP_ID_GET_RI_INBOUND_STATE = "WF.GET_RI_INBOUND_STATE";

    @Autowired
    private RIB05050E0DAO dao;
