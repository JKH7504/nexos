...
import nexos.dao.ld.LDC04030E0DAO;
...
/**
 * Class: LDC04030E0Service<br>
 * Description: 운행일지 (LDC04030E0) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service
public class LDC04030E0Service extends ServiceSupport {

    final String             SP_ID_LD_FW_BU_CLOSING_DAILY = "LD_FW_BU_CLOSING_DAILY";
    final String             SP_ID_LD_BW_BU_CLOSING_DAILY = "LD_BW_BU_CLOSING_DAILY";

    @Autowired
    private LDC04030E0DAO    dao;
    @Autowired
    ...
    public String saveP2(Map<String, Object> params) throws Exception {
        ...
        String policyCM710 = (String)params.get("P_POLICY_CM710");
        if ("1".equals(policyCM710)) {
            // [네이버] 거리계산 Service 호출
    ...
    public Map<String, Object> callLDProcessing(Map<String, Object> params) throws Exception {
        ...
        String PROCEDURE_ID = Consts.DIRECTION_FW.equals(PROCESS_DIV) ? SP_ID_LD_FW_BU_CLOSING_DAILY : SP_ID_LD_BW_BU_CLOSING_DAILY;
