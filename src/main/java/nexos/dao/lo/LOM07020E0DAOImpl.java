...
/**
 * Class: LOM07020E0DAOImpl<br>
 * Description: LOM07020E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LOM07020E0DAO")
public class LOM07020E0DAOImpl extends DaoSupport implements LOM07020E0DAO {

    final String PROGRAM_ID                      = "LOM07020E0";
    ...
    public void returnSave(Map<String, Object> params) throws Exception {
        ...
        if (dsCnt < 1) {
            throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOM07020E0.001", "온라인 반입예정등록 상세내역이 존재하지 않습니다."));
        }
