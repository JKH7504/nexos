...
/**
 * Class: LOF01010E0DAOImpl<br>
 * Description: LOF01010E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LOF01010E0DAO")
public class LOF01010E0DAOImpl extends DaoSupport implements LOF01010E0DAO {

    final String PROGRAM_ID              = "LOF01010E0";
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        if (Consts.PROCESS_ORDER_CREATE.equals(processCd)) {
            ...
            if (dsCnt < 1) {
                throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.LOF01010E0.001", "출고예정등록 상세내역이 존재하지 않습니다."));
            }
