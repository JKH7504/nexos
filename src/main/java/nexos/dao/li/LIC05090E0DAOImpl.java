...
/**
 * Class: LIC05090E0DAOImpl<br>
 * Description: LIC05090E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LIC05090E0DAO")
public class LIC05090E0DAOImpl extends DaoSupport implements LIC05090E0DAO {

    final String PROGRAM_ID        = "LIC05090E0";

    final String TABLE_NM_LI020NM  = "LI020NM";
    final String UPDATE_ID_LI020NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LI020NM;

    final String TABLE_NM_LI090NM  = "LI090NM";
    final String INSERT_ID_LI090NM = PROGRAM_ID + ".INSERT_" + TABLE_NM_LI090NM;
    final String UPDATE_ID_LI090NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LI090NM;
    ...
    public void saveSub(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_C.equals(rowCrud)) {
                ...
                insertSql(INSERT_ID_LI090NM, rowData);
            } else if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LI090NM, rowData);
            }
        }
    }
