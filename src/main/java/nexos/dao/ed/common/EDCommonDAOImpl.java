...
public class EDCommonDAOImpl extends DaoSupport implements EDCommonDAO, Comparator<Vector<Object>> {
    ...
    final String         SP_ID_ER_ERROR_PROCESSING     = "ER_ERROR_PROCESSING";
    ...
    @Override
    public Map<String, Object> callERErrorProcessing(Map<String, Object> params) {

        return callProcedure(SP_ID_ER_ERROR_PROCESSING, params);
    }
