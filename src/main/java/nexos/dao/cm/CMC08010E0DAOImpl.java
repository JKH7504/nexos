...
public class CMC08010E0DAOImpl extends DaoSupport implements CMC08010E0DAO {
    ...
    final String PROGRAM_ID       = "CMC08010E0";

    final String TABLE_NM_CMDEPT  = "CMDEPT";
    final String INSERT_ID_CMDEPT = PROGRAM_ID + ".INSERT_" + TABLE_NM_CMDEPT;
    final String UPDATE_ID_CMDEPT = PROGRAM_ID + ".UPDATE_" + TABLE_NM_CMDEPT;
    final String DELETE_ID_CMDEPT = PROGRAM_ID + ".DELETE_" + TABLE_NM_CMDEPT;
