...
public class CMC01050E0DAOImpl extends DaoSupport implements CMC01050E0DAO {
    ...
    final String PROGRAM_ID       = "CMC01050E0";

    final String TABLE_NM_CMDOCK  = "CMDOCK";
    final String INSERT_ID_CMDOCK = PROGRAM_ID + ".INSERT_" + TABLE_NM_CMDOCK;
    final String UPDATE_ID_CMDOCK = PROGRAM_ID + ".UPDATE_" + TABLE_NM_CMDOCK;
    final String DELETE_ID_CMDOCK = PROGRAM_ID + ".DELETE_" + TABLE_NM_CMDOCK;
