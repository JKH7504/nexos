...
public class CMC01010E0DAOImpl extends DaoSupport implements CMC01010E0DAO {
    ...
    final String PROGRAM_ID         = "CMC01010E0";

    final String TABLE_NM_CMCENTER  = "CMCENTER";
    final String INSERT_ID_CMCENTER = PROGRAM_ID + ".INSERT_" + TABLE_NM_CMCENTER;
    final String UPDATE_ID_CMCENTER = PROGRAM_ID + ".UPDATE_" + TABLE_NM_CMCENTER;
    final String DELETE_ID_CMCENTER = PROGRAM_ID + ".DELETE_" + TABLE_NM_CMCENTER;
