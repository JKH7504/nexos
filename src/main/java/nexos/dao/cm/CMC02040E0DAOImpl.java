...
public class CMC02040E0DAOImpl extends DaoSupport implements CMC02040E0DAO {
    ...
    final String PROGRAM_ID         = "CMC02040E0";

    final String TABLE_NM_CMCARREF  = "CMCARREF";
    final String INSERT_ID_CMCARREF = PROGRAM_ID + ".INSERT_" + TABLE_NM_CMCARREF;
    final String UPDATE_ID_CMCARREF = PROGRAM_ID + ".UPDATE_" + TABLE_NM_CMCARREF;
    final String DELETE_ID_CMCARREF = PROGRAM_ID + ".DELETE_" + TABLE_NM_CMCARREF;
