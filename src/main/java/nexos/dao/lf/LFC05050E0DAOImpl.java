...
/**
 * Class: LFC05050E0DAOImpl<br>
 * Description: LFC05050E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05050E0DAO")
public class LFC05050E0DAOImpl extends DaoSupport implements LFC05050E0DAO {

    final String PROGRAM_ID        = "LFC05050E0";

    final String TABLE_NM_LF270NM  = "LF270NM";
    final String UPDATE_ID_LF270NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF270NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF270NM, rowData);
            }
        }
    }
}
