...
/**
 * Class: LFC05100E0DAOImpl<br>
 * Description: LFC05100E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05100E0DAO")
public class LFC05100E0DAOImpl extends DaoSupport implements LFC05100E0DAO {

    final String PROGRAM_ID        = "LFC05100E0";

    final String TABLE_NM_LF260NM  = "LF260NM";
    final String UPDATE_ID_LF260NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF260NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF260NM, rowData);
            }
        }
    }
}
