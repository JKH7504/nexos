...
/**
 * Class: LFC05030E0DAOImpl<br>
 * Description: LFC05030E0 DAO (Data Access Object)<br>
 ...
 * ---------  ------------  ---------------  ---------------------------------------------------------------------------
 *  1.0        2021-04-15    ASETEC           신규작성
 * ---------------------------------------------------------------------------------------------------------------------
 *          </pre>
 */
@Repository("LFC05030E0DAO")
public class LFC05030E0DAOImpl extends DaoSupport implements LFC05030E0DAO {

    final String PROGRAM_ID        = "LFC05030E0";

    final String TABLE_NM_LF210NM  = "LF210NM";
    final String UPDATE_ID_LF210NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF210NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF210NM, rowData);
            }
        }
