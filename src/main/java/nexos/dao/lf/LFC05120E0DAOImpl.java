...
/**
 * Class: LFC05120E0DAOImpl<br>
 * Description: LFC05120E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("LFC05120E0DAO")
public class LFC05120E0DAOImpl extends DaoSupport implements LFC05120E0DAO {

    final String PROGRAM_ID        = "LFC05120E0";

    final String TABLE_NM_LF240NM  = "LF240NM";
    final String UPDATE_ID_LF240NM = PROGRAM_ID + ".UPDATE_" + TABLE_NM_LF240NM;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        for (int i = 0; i < dsCnt; i++) {
            ...
            if (Consts.DV_CRUD_U.equals(rowCrud)) {
                updateSql(UPDATE_ID_LF240NM, rowData);
            }
        }
    }
}
