...
/**
 * Class: RIB01010E0DAOImpl<br>
 * Description: RIB01010E0 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("RIB01010E0DAO")
public class RIB01010E0DAOImpl extends DaoSupport implements RIB01010E0DAO {

    final String PROGRAM_ID          = "RIB01010E0";
    ...
    final String DELETE_ID_RI010NM   = PROGRAM_ID + ".DELETE_" + TABLE_NM_RI010NM;

    final String TABLE_NM_RI010ND    = "RI010ND";
    final String INSERT_ID_RI010ND   = PROGRAM_ID + ".INSERT_" + TABLE_NM_RI010ND;
    final String UPDATE_ID_RI010ND   = PROGRAM_ID + ".UPDATE_" + TABLE_NM_RI010ND;
    final String DELETE_ID_RI010ND   = PROGRAM_ID + ".DELETE_" + TABLE_NM_RI010ND;
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        if (Consts.PROCESS_ORDER_CREATE.equals(processCd)) {
            ...
            if (dsCnt < 1) {
                throw new RuntimeException(NexosMessage.getDisplayMsg("JAVA.RIB01010E0.001", "반입예정등록 상세내역이 존재하지 않습니다."));
            }
