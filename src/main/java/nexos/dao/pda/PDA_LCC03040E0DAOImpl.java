...
/**
 * Class: PDA_LCC03040E0Impl<br>
 * Description: PDA 재고이동 DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("PDA_LCC03040E0DAO")
public class PDA_LCC03040E0DAOImpl extends DaoSupport implements PDA_LCC03040E0DAO {

    final String PROGRAM_ID         = "PDA_LCC03040E0";

    final String SP_ID_LC_PROC_MOVE = PROGRAM_ID + ".LC_PROC_MOVE"; // [센터운영]재고이동 - 재고이동 처리
