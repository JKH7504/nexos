...
/**
 * Class: PDA_LCC03030E0Impl<br>
 * Description: PDA 재고이동(멀티) DAO (Data Access Object)<br>
 ...
 *          </pre>
 */
@Repository("PDA_LCC03030E0DAO")
public class PDA_LCC03030E0DAOImpl extends DaoSupport implements PDA_LCC03030E0DAO {

    final String PROGRAM_ID         = "PDA_LCC03030E0";

    final String SP_ID_LC_PROC_MOVE = PROGRAM_ID + ".LC_PROC_MOVE"; // [센터운영]재고이동(멀티) - 재고이동 처리
