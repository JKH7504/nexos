    ...
    switch (id) {
        ...
        case "CUST_CD":
            ...
            if ($NC.isNotNull(val) && $NC.getValue("#cboQCenter_Cd") == $ND.C_ALL) {
                alert($NC.getDisplayMsg("JS.LVC03020Q0.001", "물류센터를 먼저 선택 하십시오."));
                $NC.setValue("#edtQCust_Cd");
        ...
        case "BU_CD":
            ...
            if ($NC.isNotNull(val) && $NC.isNull(CUST_CD)) {
                alert($NC.getDisplayMsg("JS.LVC03020Q0.002", "고객사를 먼저 입력 하십시오."));
                $NC.setValue("#edtQBu_Cd");
        ...
        case "BRAND_CD":
            ...
            if ($NC.isNotNull(val) && $NC.isNull(BU_CD)) {
                alert($NC.getDisplayMsg("JS.LVC03020Q0.003", "사업부를 먼저 입력 하십시오."));
                $NC.setValue("#edtQBrand_Cd");
...
function _Inquiry() {
    ...
    // 주간, 월간, 분기, 연간
    $NC.serviceCall("/LVC03020Q0/getDataSet.do", {
        P_QUERY_ID: "LVC03020Q0.RS_MASTER",
        P_QUERY_PARAMS: {
            ...
            switch (rowData.CHT_TYPE) {
                case "WEEK":
                    if (rowData.YEAR_TYPE == "CURRENT") {
                        dsChart[0][0].push(rowData.IN_QTY);
                    } else if (rowData.YEAR_TYPE == "PREV") {
                        dsChart[0][1].push(rowData.IN_QTY);
                    }
                    if ($.inArray(rowData.IN_DATE, dsTicks[0]) < 0) {
                        dsTicks[0].push(rowData.IN_DATE);
                    }
                    break;
                case "MONTH":
                    if (rowData.YEAR_TYPE == "CURRENT") {
                        dsChart[1][0].push(rowData.IN_QTY);
                    } else if (rowData.YEAR_TYPE == "PREV") {
                        dsChart[1][1].push(rowData.IN_QTY);
                    }
                    if ($.inArray(rowData.IN_DATE, dsTicks[1]) < 0) {
                        dsTicks[1].push(rowData.IN_DATE);
                    }
                    break;
                case "QUARTER":
                    if (rowData.YEAR_TYPE == "CURRENT") {
                        dsChart[2][0].push(rowData.IN_QTY);
                    } else if (rowData.YEAR_TYPE == "PREV") {
                        dsChart[2][1].push(rowData.IN_QTY);
                    }
                    if ($.inArray(rowData.IN_DATE, dsTicks[2]) < 0) {
                        dsTicks[2].push(rowData.IN_DATE);
                    }
                    break;
                case "YEAR":
                    if (rowData.YEAR_TYPE == "CURRENT") {
                        dsChart[3][0].push(rowData.IN_QTY);
                    } else if (rowData.YEAR_TYPE == "PREV") {
                        dsChart[3][1].push(rowData.IN_QTY);
                    }
                    if ($.inArray(rowData.IN_DATE, dsTicks[3]) < 0) {
                        dsTicks[3].push(rowData.IN_DATE);
                    }
                    break;
            }
        }
