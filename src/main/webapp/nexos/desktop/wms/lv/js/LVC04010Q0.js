    ...
    switch (id) {
        ...
        case "CUST_CD":
            ...
            if ($NC.isNotNull(val) && $NC.getValue("#cboQCenter_Cd") == $ND.C_ALL) {
                alert($NC.getDisplayMsg("JS.LVC04010Q0.001", "물류센터를 먼저 선택 하십시오."));
                $NC.setValue("#edtQCust_Cd");
        ...
        case "BU_CD":
            ...
            if ($NC.isNotNull(val) && $NC.isNull(CUST_CD)) {
                alert($NC.getDisplayMsg("JS.LVC04010Q0.002", "고객사를 먼저 입력 하십시오."));
                $NC.setValue("#edtQBu_Cd");
        ...
        case "BRAND_CD":
            ...
            if ($NC.isNotNull(val) && $NC.isNull(BU_CD)) {
                alert($NC.getDisplayMsg("JS.LVC04010Q0.003", "사업부를 먼저 입력 하십시오."));
                $NC.setValue("#edtQBrand_Cd");
...
function _Inquiry() {
    ...
    $NC.serviceCall("/LVC04010Q0/getDataSet.do", {
        P_QUERY_ID: "LVC04010Q0.RS_MASTER1",
        P_QUERY_PARAMS: P_QUERY_PARAMS
    }, onGetWeekReport);

    $NC.serviceCall("/LVC04010Q0/getDataSet.do", {
        P_QUERY_ID: "LVC04010Q0.RS_MASTER2",
        P_QUERY_PARAMS: P_QUERY_PARAMS
    }, onGetMonthReport);

    $NC.serviceCall("/LVC04010Q0/getDataSet.do", {
        P_QUERY_ID: "LVC04010Q0.RS_MASTER3",
        P_QUERY_PARAMS: P_QUERY_PARAMS
    }, onGetQuarterReport);

    $NC.serviceCall("/LVC04010Q0/getDataSet.do", {
        P_QUERY_ID: "LVC04010Q0.RS_MASTER4",
        P_QUERY_PARAMS: P_QUERY_PARAMS
    }, onGetYearReport);
...
function showUserBuPopup() {
    ...
    if ($NC.isNull(CUST_CD)) {
        alert($NC.getDisplayMsg("JS.LVC04010Q0.002", "고객사를 먼저 선택 하십시오."));
        $NC.setFocus("#edtQCust_Cd");
        return;
    }
...
function showBuBrandPopup() {
    ...
    var BU_CD = $NC.getValue("#edtQBu_Cd");
    if ($NC.isNull(BU_CD)) {
        alert($NC.getDisplayMsg("JS.LVC04010Q0.003", "사업부를 먼저 선택 하십시오."));
        $NC.setFocus("#edtQBu_Cd");
        return;
    }
