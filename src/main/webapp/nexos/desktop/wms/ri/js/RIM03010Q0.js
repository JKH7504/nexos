...
function _OnConditionChange(e, view, val) {
    ...
    switch (id) {
        ...
        case "BRAND_CD":
            ...
            if ($NC.isNull(BU_CD)) {
                alert($NC.getDisplayMsg("JS.RIM03010Q0.001", "사업부를 먼저 선택 하십시오."));
                $NC.setValue("#edtQBrand_Cd");
        ...
        case "DELIVERY_CD":
            ...
            return;
        case "INBOUND_DATE1":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.RIM03010Q0.002", "검색 시작일자를 정확히 입력하십시오."));
            break;
        case "INBOUND_DATE2":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.RIM03010Q0.003", "검색 종료일자를 정확히 입력하십시오."));
            break;
    }
...
function grdT1MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT1Master", {
        ...
        queryId: "RIM03010Q0.RS_T1_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT2MasterAInitialize() {
    ...
    $NC.setInitGridObject("#grdT2MasterA", {
        ...
        queryId: "RIM03010Q0.RS_T2_MASTER",
...
function grdT2DetailAInitialize() {
    ...
    $NC.setInitGridObject("#grdT2DetailA", {
        ...
        queryId: "RIM03010Q0.RS_T2_DETAIL",
        sortCol: "LINE_NO",
        gridOptions: options
    });
...
function grdT3MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT3Master", {
        ...
        queryId: "RIM03010Q0.RS_T3_MASTER",
        sortCol: "BU_CD",
        gridOptions: options
    });
...
function setSubSummaryInfo() {
    ...
    $NC.serviceCall("/RIM03010Q0/getDataSet.do", {
        P_QUERY_ID: "RIM03010Q0.RS_T2_SUB",
        P_QUERY_PARAMS: {
            P_CENTER_CD: CENTER_CD,
            P_INBOUND_DATE1: INBOUND_DATE1,
            P_INBOUND_DATE2: INBOUND_DATE2,
...
function showDeliveryPopup() {
    ...
    $NP.showDeliveryPopup({
        title: $NC.getDisplayMsg("JS.RIM03010Q0.008", "온라인몰 검색"),
        columnTitle: [
            "온라인몰코드",
            "온라인몰명"
        ],
