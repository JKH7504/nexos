 ...
 *  프로그램ID         : LIC03010Q1
 *  프로그램명         : 입고진행현황 [의류]
 *  프로그램설명       : 입고진행현황 [의류] 화면 Javascript
...
function _OnConditionChange(e, view, val) {
    ...
    switch (id) {
        ...
        case "BRAND_CD":
            ...
            if ($NC.isNull(BU_CD)) {
                alert($NC.getDisplayMsg("JS.LIC03010Q1.001", "사업부를 먼저 선택 하십시오."));
                $NC.setValue("#edtQBrand_Cd");
        ...
        case "VENDOR_CD":
            ...
            return;
        case "INBOUND_DATE1":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LIC03010Q1.002", "검색 시작일자를 정확히 입력하십시오."));
            break;
        case "INBOUND_DATE2":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LIC03010Q1.003", "검색 종료일자를 정확히 입력하십시오."));
            break;
    }
...
function grdT1MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT1Master", {
        ...
        queryId: "LIC03010Q1.RS_T1_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT2MasterAInitialize() {
    ...
    $NC.setInitGridObject("#grdT2MasterA", {
        ...
        queryId: "LIC03010Q1.RS_T2_MASTER",
...
function grdT2DetailAInitialize() {
    ...
    $NC.setInitGridObject("#grdT2DetailA", {
        ...
        queryId: "LIC03010Q1.RS_T2_DETAIL",
        sortCol: "LINE_NO",
        gridOptions: options
    });
...
function grdT3MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT3Master", {
        ...
        queryId: "LIC03010Q1.RS_T3_MASTER",
        sortCol: "BU_CD",
        gridOptions: options
    });
...
function setSubSummaryInfo() {
    ...
    $NC.serviceCall("/LIC03010Q0/getDataSet.do", {
        P_QUERY_ID: "LIC03010Q1.RS_T2_SUB",
        P_QUERY_PARAMS: {
            P_CENTER_CD: CENTER_CD,
            P_INBOUND_DATE1: INBOUND_DATE1,
            P_INBOUND_DATE2: INBOUND_DATE2,
