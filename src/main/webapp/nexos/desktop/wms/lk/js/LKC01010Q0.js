...
function _OnConditionChange(e, view, val) {
    ...
    switch (id) {
        ...
        case "BRAND_CD":
            ...
            return;
        case "INOUT_DATE1":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LKC01010Q0.001", "검색 시작일자를 정확히 입력하십시오."));
            break;
        case "INOUT_DATE2":
            $NC.setValueDatePicker(view, val, $NC.getDisplayMsg("JS.LKC01010Q0.002", "검색 종료일자를 정확히 입력하십시오."));
            break;
        case "DEPT_CD":
            $NP.onDeptChange(val, {
        ...
        case "T5_DISPLAY_DIV2":
            if (val == $ND.C_NO) {
                if ($NC.isNull($NC.getValueCheckGroup("chk" + $NC.G_VAR.activeTab + "_Display_Div"))) {
                    alert($NC.getDisplayMsg("JS.LKC01010Q0.003", "표시항목은 하나 이상 선택해야 됩니다."));
...
function _Inquiry() {
    ...
    if ($NC.isNull(CENTER_CD)) {
        alert($NC.getDisplayMsg("JS.LKC01010Q0.004", "물류센터를 선택하십시오."));
        $NC.setFocus("#cboQCenter_Cd");
        return;
    }
    var BU_CD = $NC.getValue("#edtQBu_Cd");
    if ($NC.isNull(BU_CD)) {
        alert($NC.getDisplayMsg("JS.LKC01010Q0.005", "사업부를 입력하십시오."));
        $NC.setFocus("#edtQBu_Cd");
        return;
    }
    var INOUT_DATE1 = $NC.getValue("#dtpQInout_Date1");
    if ($NC.isNull(INOUT_DATE1)) {
        alert($NC.getDisplayMsg("JS.LKC01010Q0.006", "검색 시작일자를 입력하십시오."));
        $NC.setFocus("#dtpQInout_Date1");
        return;
    }
    var INOUT_DATE2 = $NC.getValue("#dtpQInout_Date2");
    if ($NC.isNull(INOUT_DATE2)) {
        alert($NC.getDisplayMsg("JS.LKC01010Q0.007", "검색 종료일자를 입력하십시오."));
    ...
    // 데이터 조회
    $NC.serviceCall("/LKC01010Q0/getDataSet.do", $NC.getGridParams(grdObject), onGetMaster);
}
...
function grdT1MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT1Master", {
        ...
        queryId: "LKC01010Q0.RS_T1_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT2MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT2Master", {
        ...
        queryId: "LKC01010Q0.RS_T2_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT3MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT3Master", {
        ...
        queryId: "LKC01010Q0.RS_T3_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT4MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT4Master", {
        ...
        queryId: "LKC01010Q0.RS_T4_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
...
function grdT5MasterInitialize() {
    ...
    $NC.setInitGridObject("#grdT5Master", {
        ...
        queryId: "LKC01010Q0.RS_T5_MASTER",
        sortCol: "CUST_CD",
        gridOptions: options
    });
