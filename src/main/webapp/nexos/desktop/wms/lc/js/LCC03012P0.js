 ...
 *  ==================================================================================================================================================
 *  프로그램ID         : LCC03012P0
 *  프로그램명         : 수시보충내역생성 팝업 (일반)
 *  프로그램설명       : 수시보충내역생성 팝업 (일반) 화면 Javascript
...
function _Save() {
    ...
    if (checkedData.checkedCount == 0) {
        alert($NC.getDisplayMsg("JS.LCC03012P0.001", "수시보충내역 생성할 로케이션을 선택하십시오."));
        return;
    }

    if (!confirm($NC.getDisplayMsg("JS.LCC03012P0.002", "수시보충내역을 생성 하시겠습니까?"))) {
        return;
    }
