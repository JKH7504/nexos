...
function grdMasterOnAfterScroll(e, args) {
    ...
    // 데이터 조회
    $NC.serviceCall("/PDA_LOC02370Q0/getDataSet.do", $NC.getGridParams(G_GRDDETAIL), onGetDetail, onItemError);
...
function onPaperScan($scan, scanVal) {
    ...
    // 데이터 조회
    $NC.serviceCall("/PDA_LOC02370Q0/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster, onPaperError);
}
