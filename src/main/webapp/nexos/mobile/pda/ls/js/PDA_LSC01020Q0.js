 ...
 * <pre>
 *  ==================================================================================================================================================
 *  프로그램ID         : PDA_LSC01020Q0
 *  프로그램명         : PDA 로케이션별 재고조회
 *  프로그램설명       : PDA 로케이션별 재고조회 화면 Javascript
...
function grdMasterInitialize() {
    ...
    $NC.setInitGridObject("#grdMaster", {
        ...
        queryId: "PDA_LSC01020Q0.RS_MASTER",
        sortCol: "ITEM_CD",
        gridOptions: options
    });
...
function onGetMaster(ajaxData) {
    ...
    if (dsResult.length == 0) {
        alert($NC.getDisplayMsg("JS.PDA_LSC01020Q0.XXX", "상품의 재고가 존재하지 않습니다."));
        _Cancel();
        return;
    }
...
function onLocationScan($scan, scanVal) {
    ...
    // 데이터 조회
    $NC.serviceCall("/PDA_LSC01020Q0/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster, onLocationError);
}
